...
include("config.php");
	...
	$query = "delete from mainslider where id ='".$delete_id."'";
                    ...
                    <div class="vd_content clearfix">
                        <div class="vd_title-section clearfix">
                            <div class="vd_panel-header">
                                ...
                                <small class="subtitle">List of images</small> </div>
                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="panel widget">
                                        <div class="panel-heading vd_bg-grey">
                                            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> All images </h3>
                                        </div>
                                        <div class="panel-body-list  table-responsive">
                                            <table class="table table-striped table-hover no-head-border">
                                                ...
                                                $query="SELECT * from mainslider order by id DESC";

	$run = mysqli_query($conn,$query);
                                                foreach($run as $ke=>$value){
                                                ?><tr>
                          <td><img src="../images/slider/<?php echo $value['image'];?>" with="50px" height="50px"></td>
                          
							
						 <td class="menu-action rounded-btn"><a href="slideredit.php?catid=<?php echo $value['id'];?>" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a> <a href="viewmain_slider.php?del=<?php echo $value['id'];?>"   data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-times"></i> </a></td>
                         <td><button class=" " onclick="return confirm('Are you sure?')"><?php if(($value['status'])=='0')
{
?>
<a href="action.php?status=<?php echo $value['id'];?>" 
 class="act btn  btn-danger " onclick="return confirm('Activate <?php echo $data?>');"> Deactivate </a>
<?php
}
if($value['status']=='1')
{
?>
<a href="action.php?status=<?php echo $value['id'];?>" 
 class="deact btn btn-success " onclick="return confirm('De-activate <?php echo $data?>');"> Activate</a>
<?php
} ?> </button></td></tr>
        ...
        <div class="vd_bottom ">
            <div class="container">
                <div class="row">
                    <div class=" col-xs-12">
                        <div class="copyright">
                            Copyright &copy;2015 Godogee  Inc. All Rights Reserved
                        </div>
                    </div>
                </div><!-- row -->
            </div><!-- container -->
