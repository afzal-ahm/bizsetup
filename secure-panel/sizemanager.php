...
$size  = $_POST['size'];
$field_value=array($product_sku,$size,$quantity);
 $field =array('sku','size','quantity');
 $res_exist = $con->already_exist($table,$field,$field_value);
...
<script>
alert("size uploaded");
window.location ='sizemanager.php'
</script>
<?php
}
else{
