...
$field_value=array($service,$sub,$content);
$field =array('service','subservice','content');
...
window.location ='viewsubmedical.php'
</script>
<?php
}
else{
...
<head>
    ...
    <!-- Plugin CSS --><script src="ckeditor/ckeditor.js"></script>
    ...
    <div data-action="remove-navbar" data-original-title="Remove Navigation Bar Toggle" data-toggle="tooltip" data-placement="bottom" class="remove-navbar-button menu"> <i class="fa fa-arrows-h"></i> </div>
      ...
      <div data-action="fullscreen" data-original-title="Remove Navigation Bar and Top Menu Toggle" data-toggle="tooltip" data-placement="bottom" class="fullscreen-button menu"> <i class="glyphicon glyphicon-fullscreen"></i> </div>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Sub Medical Panel</h1>
              <small class="subtitle">Godogee  Dashboard</small>
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Add services </h3>
                  </div>
                  <div class="panel-body">
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          ...
                          <select class="width-40" name="service">
                          <option required value=""> Select</option> 
                            <?php
      include_once "config.php";
   //   session_start();
  // echo $sql = "SELECT DISTINCT category FROM category";
		...
		while ($row=mysqli_fetch_array($run))
   {
   	...
   	?>
                             <option value="<?php echo $row['medical'];?>"><?php echo $row['medical'];?></option> 
                             <?php 
					  ...
					  <div class="form-group">
                        <label class="col-sm-2 control-label">Sub service name</label>
                        <div class="col-sm-7 controls">
                           <input type="text" name="sub" class="form-control" required>
                        </div>
                      </div>
					   <div class="form-group">
                        <label class="col-sm-2 control-label">Content of Sub medical</label>
                        <div class="col-sm-7 controls">
                         
                       <textarea class="ckeditor" id="" cols="70" name="content" rows="20" required>                                    		
                                    	</textarea>
                        </div>
                      </div>
