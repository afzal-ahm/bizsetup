...
if($image_type=="image/jpeg" or $image_type=="image/png" or $image_type=="img/gif"){
	if ($image_size<=5000000){
  	move_uploaded_file($image_tmp, "../images/newproduct/$image_name");
	}
	else{
...
$query="UPDATE new_products SET img='$image_name', content='$terms' where id='".$_POST['edit_id']."'";
	// $query = "UPDATE term_condition SET about='$terms', img='$image_name' WHERE id='1' ";
	 	 $me=mysqli_query($conn,$query);
	 	 }

elseif($_FILES['image']['name'] ==""){
	$query="UPDATE new_products SET  content='$terms' where id='".$_POST['edit_id']."'";
...
$query="SELECT * FROM new_products where id='".@$_GET['edit']."'";
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="file"  data-toggle="tooltip" data-placement="top" name="image" >
                           <p>Images Size Should be "width="370 pixels" height="369 pixels" ".   </p>
                        </div>
                         <div class="col-sm-3 controls">
                        <img src="../images/newproduct/<?php echo $image; ?>" width="80" height="80" >
