...
$title1 = $_POST['title1']; //echo $title1;
$title2  = $_POST['title2'];
...
$image1 = $_FILES['image1']['name'];//echo $image1;
$image_tmp = $_FILES['image1']['tmp_name']; 
$path="images/sliders/sliderimgone/";
$image=$path.$image1;
move_uploaded_file($image_tmp,"../$image");
}


if(isset($_FILES['bgimage']['name']) !=""){
$image4 = $_FILES['bgimage']['name'];//echo $image1;
$image_tmp = $_FILES['bgimage']['tmp_name']; 
$path4="images/sliders/bg2/";
$image41=$path4.$image4;
move_uploaded_file($image_tmp,"../$image41");
}
if($image1!='' && $image4==''){
	$see="UPDATE mainslider SET title1='".$title1."' , title2='".$title2."', content1='".$content1."',content2='".$content2."', name='".$name."',single_image='".$image."' WHERE slider_id=2";
$me=mysqli_query($conn,$see);
//echo $see;
	}
	
	elseif($image4!='' && $image1==''){
		$see="UPDATE mainslider SET title1='".$title1."' , title2='".$title2."', content1='".$content1."',content2='".$content2."', name='".$name."',bg_image='".$image41."' WHERE slider_id=2";
$me=mysqli_query($conn,$see);
//echo $see;
		
		}
		elseif($image4!='' && $image1!=''){
			$see="UPDATE mainslider SET title1='".$title1."' , title2='".$title2."', content1='".$content1."',content2='".$content2."', name='".$name."',bg_image='".$image41."',single_image='".$image."' WHERE slider_id=2";
$me=mysqli_query($conn,$see);
...
$see="UPDATE mainslider SET title1='".$title1."' , title2='".$title2."', content1='".$content1."',content2='".$content2."', name='".$name."' WHERE slider_id=2";
$me=mysqli_query($conn,$see);
//echo $see;
    ...
    <div data-action="remove-navbar" data-original-title="Remove Navigation Bar Toggle" data-toggle="tooltip" data-placement="bottom" class="remove-navbar-button menu"> <i class="fa fa-arrows-h"></i> </div>
      ...
      <div data-action="fullscreen" data-original-title="Remove Navigation Bar and Top Menu Toggle" data-toggle="tooltip" data-placement="bottom" class="fullscreen-button menu"> <i class="glyphicon glyphicon-fullscreen"></i> </div>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Bonitopanos Dashboard</h1>
              <small class="subtitle">Bonitopanos Dashboard</small>
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Main Slider Manager </h3>
                  </div>
                  <div class="panel-body">
                    <form class="form-horizontal" action="addmain_slider2.php" role="form" method="post" enctype="multipart/form-data">
                  ...
                  <?php
//include_once"adminpanel/dbMysql.php";

$table ="mainslider";
$con = new DB_con();
$field_value=array(1);
$field =array('design','slider_id','image1','image2','image3','title1','title2','content1','content2','name','bg_image','single_image');
...
<?php
                ...
                <div  class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="some title" data-toggle="tooltip" data-placement="top" name="title1" value="<?php echo ''.$value['title1'].''; ?>" required>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="remaining title" data-toggle="tooltip" data-placement="top" name="title2" value="<?php echo ''.$value['title2'].''; ?>" required>
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <textarea name="content1"  required><?php echo ''.$value['content1'].''; ?></textarea>
                        </div>
                      </div>
					  <div class="form-group">
                        <label class="col-sm-2 control-label">Content2</label>
                        <div class="col-sm-7 controls">
                          <textarea name="content2"  required><?php echo ''.$value['content1'].''; ?></textarea>
                        </div>
                      </div>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Name" data-toggle="tooltip" data-placement="top" name="name" value="<?php echo ''.$value['name'].''; ?>" required>
                        </div>
                      </div>
                      
                      <div  class="form-group">
                        <label class="col-sm-2 control-label">Add Single Image </label>
                        <div class="col-sm-7 controls">
                         <img src="../<?php echo ''.$value['single_image'].''; ?>" width="80px" height="80px">
                          <input class="width-70" type="file"  placeholder="Input" data-toggle="tooltip" data-placement="top" name="image1" >
                        </div>
                      </div>
					  ...
					  <div class="form-group">
                        <label class="col-sm-2 control-label">Add Background Image</label>
                        <div class="col-sm-7 controls">
                         <img src="../<?php echo ''.$value['bg_image'].''; ?>" width="80px" height="80px">
                          <input class="width-70" type="file" placeholder="Input" data-toggle="tooltip" data-placement="top" name="bgimage" >
                        </div>
                      </div>
    ...
    <div class="vd_bottom ">
        <div class="container">
            <div class="row">
              <div class=" col-xs-12">
                <div class="copyright">
                  	Copyright &copy;2015 Bonitopanos Inc. All Rights Reserved
                </div>
              </div>
            </div><!-- row -->
        </div><!-- container -->
