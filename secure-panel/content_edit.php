 ...
 if(isset($_POST['submit']))
{
	...
	//$query="INSERT into testimonial (name,content) VALUES ('$name','$content')";
	
	
	 
	 $query="UPDATE top_heading set content='$content1',fast_free='$content2',safe_secure='$content3',get_order='$content4',money_back='$content5' where id='2'";
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Content for change </h3>
                  </div>
...
?>
                   ...
                   <form class="form-horizontal" action="#" method="post" name="form" role="form" enctype="multipart/form-data">
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input" value="<?php echo $row['content']; ?>" data-toggle="tooltip" data-placement="top" name="content1" > 
                        </div>
                      </div>
  				...
  				<input class="width-70" type="text" value="<?php echo $row['fast_free']; ?>" data-toggle="tooltip"  data-placement="top" name="content2" >
                       ...
                       <div class="form-group">
                        <label class="col-sm-2 control-label">Content3</label>
                        <div class="col-sm-7 controls">
                        
  				<input class="width-70" type="text" value="<?php echo $row['safe_secure']; ?>" data-toggle="tooltip"  data-placement="top" name="content3" >
                       ...
                       <div class="form-group">
                        <label class="col-sm-2 control-label">Content4</label>
                        <div class="col-sm-7 controls">
                        
  				<input class="width-70" type="text" value="<?php echo $row['get_order']; ?>" data-toggle="tooltip"  data-placement="top" name="content4" >
                       ...
                       <div class="form-group">
                        <label class="col-sm-2 control-label">Content5</label>
                        <div class="col-sm-7 controls">
                        
  				<input class="width-70" type="text" value="<?php echo $row['money_back']; ?>" data-toggle="tooltip"  data-placement="top" name="content5" >
