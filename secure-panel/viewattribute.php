...
$del="DELETE FROM `product_color` WHERE id='".$color."'";
$r=mysqli_query($conn,$del);
if($r)
{
	
 echo '<script>window.location.assign("viewattribute.php?sku='.$sku.'")</script>'; 
}
...
$del="DELETE FROM `product_size` WHERE id='".$size."'";
$r=mysqli_query($conn,$del);
if($r)
{
                            ...
                            <div class="col-md-12">
                                <div class="panel widget">
                                    <div class="panel-heading vd_bg-grey">
                                        <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span>  View Attributes <Images></Images></h3>
                                    </div>

                                    <div class="panel-body datesec" id="datesec">
                                            ...
                                            <table class="table table-striped table-hover no-head-border">
                                                ...
                                                $sel="SELECT * from product_color where sku='".$_GET['sku']."'";
                                                $run=mysqli_query($conn,$sel);
                                                foreach($run as $key =>$valattr){
                                                    ?>
                                                    <tr>
                                                      
                                                       
                                                        
                                                        <td><?php echo $_GET['sku'] ;?></td>
                                                        <td>color</td>
                                                        <td><?php echo $valattr['color'] ;?></td>
                                                        
                                                        <td class="menu-action"><!--<a href="viewproductattribute.php?edit=<?php echo $valattr['id']; ?>" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bd-yellow vd_yellow" > <i class="fa fa-pencil"></i> </a> --><a href="viewattribute.php?color=<?php echo $valattr['id']; ?>&sku=<?php echo $_GET['sku'] ;?>" data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bd-red vd_red  confirmation"> <i class="fa fa-times"></i> </a></td>
                                                    </tr>
                                                <?php  }?>
 <?php
                                                
                                                $sel="SELECT * from product_size where sku='".$_GET['sku']."'";
                                                $run=mysqli_query($conn,$sel);
                                                foreach($run as $key =>$valattr){
                                                    ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $_GET['sku'] ;?></td>
                                                        <td>Size</td>
                                                        <td><?php echo $valattr['size'] ;?></td>
                                                        
                                                        <td class="menu-action"><!--<a href="viewproductattribute.php?edit=<?php echo $valattr['id']; ?>" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bd-yellow vd_yellow" > <i class="fa fa-pencil"></i> </a> --><a href="viewattribute.php?size=<?php echo $valattr['id']; ?>&sku=<?php echo $_GET['sku'] ;?>" data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bd-red vd_red  confirmation"> <i class="fa fa-times"></i> </a></td>
                                                    </tr>
                                                <?php  }?>
                                    ...
                                    <div class="panel-body" id="datesec">
                                    </div>
