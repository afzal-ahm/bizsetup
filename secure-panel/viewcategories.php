...
<div class="vd_body">
                    ...
                    <div class="vd_content clearfix">
                        <div class="vd_title-section clearfix">
                            <div class="vd_panel-header">
                                ...
                                <small class="subtitle">List of Category</small> </div>
                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="panel widget">
                                        <div class="panel-heading vd_bg-grey">
                                            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> All Category </h3>
                                        </div>
    ...
    foreach($g as $value){
        ...
        if($value['is_active'] == 1){
            echo '<td><span class="badge bg-success btn-success"  style="    background-color: #4cae4c !important;">Active</span></td>';
        } else {
            echo '<td><span class="badge bg-danger btn-danger" style="    background-color: #d9534f !important;">Deactive</span></td>';
        }

        // ✅ Action Buttons
        echo '<td class="menu-action rounded-btn">
                <a href="editcat.php?catid='.$value['category_id'].'" 
                   data-original-title="edit" data-toggle="tooltip" 
                   data-placement="top" class="btn menu-icon vd_bg-grey"> 
                   <i class="fa fa-pencil"></i> 
                </a> 

                <a href="viewcategories.php?deletecat='.$value['category_id'].'" 
