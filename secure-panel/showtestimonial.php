                    ...
                    <div class="vd_content clearfix">
                        <div class="vd_title-section clearfix">
                            <div class="vd_panel-header">
                                <h1>testimonails</h1>
                                <small class="subtitle">List of testimonails</small> </div>
                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="panel widget">
                                        <div class="panel-heading vd_bg-grey">
                                            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> All testimonails </h3>
                                        </div>
...
?>
  ...
  <td class="center"><a href="edit6.php?edit=<?php echo $id; ?> "class=" btn btn-success btn-rounded">Edit</a></td>
  <td class="center"><a href="del6.php?del=<?php echo $id; ?> "class=" btn btn-danger btn-rounded">Delete</a></td>
