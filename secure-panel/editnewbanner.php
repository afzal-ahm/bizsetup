...
include_once 'config.php';
 $dd="SELECT * from allbannerhome where id='".$_GET['id']."'";
...
$offer = $_POST['offer'];
   ...
   $contentsmall = $_POST['contentsmall'];
   $page = $_POST['page'];
   $type = $_POST['type'];
...
$date=date('d-M-Y');
 ...
 if ($type=='single banner'){

  $up="UPDATE `allbannerhome` SET   `heading`='$heading',`contentsmall`='$contentsmall',`link1`='$link1',`page`='$page',`position`='$page',`date`='$date',`slidertype`='$type'   WHERE id='".$_GET['id']."'";
 $runc=mysqli_query($conn,$up);
  	
 }
  if ($type=='4 square banner'){

  $up="UPDATE `allbannerhome` SET   `heading`='$heading',`contentsmall`='$contentsmall',`link1`='$link1',`link2`='$link2',`link3`='$link3',`link4`='$link4',`page`='$page',`date`='$date',`slidertype`='$type',`position`='$page'  WHERE id='".$_GET['id']."'";
 $runc=mysqli_query($conn,$up);
  ...
  if ($type=='4 square banner'){
	   ...
	   $imagename1 = $random_digit1.$image1_name;
	   $query1 = "UPDATE allbannerhome SET image1='$imagename1'  where id='".$_GET['id']."'";
       move_uploaded_file($image1_tmp, "../images/banner/$imagename1");
	   ...
	   $imagename2 = $random_digit2.$image2_name;
	   $query1 = "UPDATE allbannerhome SET image2='$imagename2'  where id='".$_GET['id']."'";
       move_uploaded_file($image2_tmp, "../images/banner/$imagename2");
       $runc=mysqli_query($conn,$query1);
	  }
	   ...
	   $imagename3 = $random_digit3.$image3_name;
	   $query1 = "UPDATE allbannerhome SET image3='$imagename3'  where id='".$_GET['id']."'";
       move_uploaded_file($image3_tmp, "../images/banner/$imagename3");
       $runc=mysqli_query($conn,$query1);
	  }
	   ...
	   $imagename4 = $random_digit4.$image4_name;
	   $query1 = "UPDATE allbannerhome SET image4='$imagename4'  where id='".$_GET['id']."'";
       move_uploaded_file($image4_tmp, "../images/banner/$imagename4");
       $runc=mysqli_query($conn,$query1);
	  }  
	}
 ...
 echo'<script>location.assign("viewbannerlinks.php")</script>';
                  ...
                  <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input"  name="heading" value="<?php echo $data['heading'];?>" required >
                        </div>
                      </div>
                      
                        <div class="form-group">
                        <label class="col-sm-2 control-label">contentsmall</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input"  name="contentsmall" value="<?php echo $data['contentsmall'];?>" required >
                        </div>
                      </div>
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input"  name="page" value="<?php echo $data['page'];?>" required >
                        </div>
                      </div>
                        <div class="form-group">
                        <label class="col-sm-2 control-label">Select Category</label>
                        <div class="col-sm-7 controls">
                          <select class="width-40" name="type"  > 
                            <option value="4 square banner"> 4 square banner</option>
                             <option value="single banner"> Single </option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                        <img src="../images/banner/<?php echo $data['image1'];?>">
                          <input class="width-70" type="file" placeholder="Input"  name="image1"    >
                        </div>
                      </div>
                      
                      <div class="form-group">
                        <label class="col-sm-2 control-label">link1</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input"  name="link1" value="<?php echo $data['link1'];?>"  >
                        </div>
                      </div>
                        ...
                        <div class="col-sm-7 controls">
                        <img src="../images/banner/<?php echo $data['image2'];?>">
                          <input class="width-70" type="file" placeholder="Input"  name="image2"    >
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label">link1</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input"  name="link2" value="<?php echo $data['link2'];?>"  >
                        </div>
                      </div>
                        ...
                        <div class="col-sm-7 controls">
                        <img src="../images/banner/<?php echo $data['image3'];?>">
                          <input class="width-70" type="file" placeholder="Input"  name="image3"    >
                        </div>
                      </div>
                      
                      <div class="form-group">
                        <label class="col-sm-2 control-label">link3</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input"  name="link3" value="<?php echo $data['link3'];?>"  >
                        </div>
                      </div>
                        ...
                        <div class="col-sm-7 controls">
                        <img src="../images/banner/<?php echo $data['image4'];?>">
                          <input class="width-70" type="file" placeholder="Input"  name="image4"    >
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label">link1</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input"  name="link4" value="<?php echo $data['link4'];?>"  >
                        </div>
                      </div>
