                ...
                <div class="panel widget">
                 ...
                 <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" name="extra" required>
                        </div>
                      </div>
                         
                          <div class="form-group">
                        <label class="col-sm-2 control-label">Add Offer Price  </label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" name="price" >
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <textarea class="ckeditor "  id="" cols="70" name="content"    rows="5"  ></textarea>
                        </div>
                      </div> 
    ...
    <div class="vd_bottom ">
        <div class="container">
            <div class="row">
              <div class=" col-xs-12">
                <div class="copyright">
                  	Copyright &copy;2018 Tea Trading Inc. All Rights Reserved 
                </div>
              </div>
            </div><!-- row -->
        </div><!-- container -->
