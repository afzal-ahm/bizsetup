...
$fetch_query = "SELECT * FROM blog WHERE id = '$blog_id'";
...
$blog_data = mysqli_fetch_assoc($fetch_result);
...
if(isset($_POST['btn-update'])) {
    ...
    $imagename = $blog_data['image']; // Keep existing image by default
    ...
    if($image_name != "") {
        ...
        if($blog_data['image'] && file_exists("../images/blog/".$blog_data['image'])) {
    ...
    $update_query = "UPDATE `blog` SET 
                     ...
                     `image`=?, `category_id`=?, `tags`=?, `meta_title`=?, 
                     `meta_description`=?, `meta_keywords`=?, `status`=?, 
                     `is_featured`=?, `allow_comments`=?, `reading_time`=?, 
                     `published_date`=?, `updated_date`=NOW() 
                     WHERE id=?";
    
    $stmt = mysqli_prepare($conn, $update_query);
    if($stmt) {
        mysqli_stmt_bind_param($stmt, "ssssssssssssiiisi", $title, $slug, $content, $excerpt, $author, 
                             $imagename, $category_id, $tags, $meta_title, $meta_description, 
                             $meta_keywords, $status, $is_featured, $allow_comments, $reading_time, 
                             $published_date, $blog_id);
        ...
        if($update_result) {
            ...
            $_SESSION['error_msg'] = "Error updating blog post: " . mysqli_error($conn);
        }
    } else {
        ...
        <div class="vd_content clearfix">
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                <li><a href="">Home</a> </li>
                <li><a href="view_blog.php">Blog Management</a></li>
      ...
      <div data-action="fullscreen" data-original-title="Remove Navigation Bar and Top Menu Toggle"  class="fullscreen-button menu"> <i class="fa fa-fullscreen"></i> </div>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              ...
              <small class="subtitle">Update Blog Post Details</small>
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-edit"></i> </span> Edit Blog Post: <?php echo htmlspecialchars($blog_data['title']); ?></h3>
                  </div>
                    ...
                    <form class="form-horizontal" enctype="multipart/form-data" action="" role="form" method="post">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" name="title" id="title" placeholder="Enter blog title" value="<?php echo htmlspecialchars($blog_data['title']); ?>" required>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" name="slug" id="slug" placeholder="Auto-generated from title" value="<?php echo htmlspecialchars($blog_data['slug']); ?>">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <select class="width-70" name="category_id">
                            ...
                            ?>
                            <option value="<?php echo $category['id']; ?>" <?php echo ($blog_data['category_id'] == $category['id']) ? 'selected' : ''; ?>>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" name="author" placeholder="Enter author name" value="<?php echo htmlspecialchars($blog_data['author']); ?>">
                        </div>
                      </div>
                      
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Current Featured Image</label>
                        <div class="col-sm-7 controls">
                          <?php if($blog_data['image']): ?>
                            <img src="../images/blog/<?php echo $blog_data['image']; ?>" alt="Current Image" style="max-width: 100px; max-height: 100px;" class="img-thumbnail">
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Update Featured Image</label>
                        <div class="col-sm-7 controls">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" name="tags" placeholder="Enter tags separated by commas" value="<?php echo htmlspecialchars($blog_data['tags']); ?>">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <select class="width-70" name="status">
                            <option value="draft" <?php echo ($blog_data['status'] == 'draft') ? 'selected' : ''; ?>>Draft</option>
                            <option value="published" <?php echo ($blog_data['status'] == 'published') ? 'selected' : ''; ?>>Published</option>
                            <option value="archived" <?php echo ($blog_data['status'] == 'archived') ? 'selected' : ''; ?>>Archived</option>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" name="published_date" id="published_date" placeholder="Leave empty for current date" value="<?php echo $blog_data['published_date'] ? date('Y-m-d H:i:s', strtotime($blog_data['published_date'])) : ''; ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <div class="checkbox">
                            <label>
                              <input type="checkbox" name="is_featured" value="1" <?php echo ($blog_data['is_featured'] == 1) ? 'checked' : ''; ?>>
                              Mark as Featured Post
                            </label>
                          </div>
                          <div class="checkbox">
                            <label>
                              <input type="checkbox" name="allow_comments" value="1" <?php echo ($blog_data['allow_comments'] == 1) ? 'checked' : ''; ?>>
                              Allow Comments
                            </label>
                          </div>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <textarea class="width-70" name="excerpt" id="excerpt" rows="3" placeholder="Brief summary of the blog post (auto-generated from content)"><?php echo htmlspecialchars($blog_data['excerpt']); ?></textarea>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <textarea class="ckeditor" name="content" id="content" cols="70" rows="15" placeholder="Write your blog content here..."><?php echo htmlspecialchars($blog_data['content']); ?></textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" name="meta_title" id="meta_title" placeholder="SEO meta title (auto-generated from title)" value="<?php echo htmlspecialchars($blog_data['meta_title']); ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <textarea class="width-70" name="meta_description" rows="2" placeholder="SEO meta description"><?php echo htmlspecialchars($blog_data['meta_description']); ?></textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" name="meta_keywords" placeholder="SEO meta keywords separated by commas" value="<?php echo htmlspecialchars($blog_data['meta_keywords']); ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-7">
                          <button class="btn vd_btn vd_bg-green vd_white" type="submit" name="btn-update">
                            <i class="icon-ok"></i> Update Blog Post
                          </button>
                          <a href="view_blog.php" class="btn vd_btn vd_bg-grey vd_white">
