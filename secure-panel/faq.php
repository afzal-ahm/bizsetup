...
$field_value=array($question,$answer,$new,$name);
$field=array('question','answer','sub_sub_id','sub_name');
$res = $con->insert($field_value,$table,$field);
if($res)
{

 echo "<script>alert('FAQ Inserted.')</script>";
echo "<script>window.open('viewfaq.php?new='.$name.'','_self')</script>";
?>
...
<?php
 ...
 echo "<script>alert('FAQ Not Inserted.')</script>";
echo "<script>window.open('viewfaq.php?new='.$name.'','_self')</script>";
	?>
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Add FAQ </h3>
                  </div>
                  <div class="panel-body">
                    <form class="form-horizontal" action="#" method="post" role="form" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Add FAQ Question</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" name="question">
                        </div>
                      </div>
                        <div class="form-group">
                        <label class="col-sm-2 control-label">Add FAQ Answer</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" name="answer">
                        </div>
                      </div>
