...
if(isset($_GET['del'])){
	...
	$query = "delete from image_manager where id ='".$delete_id."'";
                ...
                <div class="vd_container">
                    <div class="vd_content clearfix">
                        ...
                        <div class="vd_content-section clearfix">
                          ...
                          <td>'.$value['service'].'</td>
                           <td>'.$value['subservice'].'</td>
                          <td>'.$value['section'].'</td>
							
						 <td class="menu-action rounded-btn"><a href="editimage.php?catid='.$value['id'].'" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a> <a href="viewimage.php?del='.$value['id'].'""   data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-times"></i> </a></td>
                        </tr>';}?>
