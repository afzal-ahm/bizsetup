...
if(isset($_POST['btn-save'])) {
    ...
    $description = $_POST['description']; $price = $_POST['price'];
       ...
       $insertx="INSERT INTO `attributemanager_2`(`sku`, `size_color`, `type`, `price`) VALUES ('$product_sku','$type','$description','$price')";
   
		   $runx=mysqli_query($conn,$insertx);
     
    $date = date('Y-m-d');
    if($type=='color')
    {
		  $table="product_color";
		   $insert="INSERT into product_color (sku,color) VALUE('$product_sku','$description')";
		   $run=mysqli_query($conn,$insert);
	}
	else{
			$table="";
			$insert="INSERT into product_size (sku,size) VALUE('$product_sku','$description')";
			 $run=mysqli_query($conn,$insert);
	}
...
<script>
alert("  Inserted");
window.location ='attibutemanager.php?sku='.$product_sku.''
</script>
<?php
}
else{
...
function getattr(){
    var Getval = jQuery(".getvalue").val();
    //alert(Getval);
    jQuery.ajax({
        url: "selectsubcategory.php",
        type: "POST",
  ...
  //alert(ranknew1);
    if (str == "") {
      ...
      //  xmlhttp.open("GET","propertyajax.php?like="+str,true);
          xmlhttp.open("GET","filter.php?p2=" +str,true);
        xmlhttp.send();
    }
}
</script>
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Add Attributes and value </h3>
                  </div>
                ...
                <div class="form-group" id="price1">
                        ...
                        <div class="col-sm-7 controls">
                         <input type="hidden" value="<?php echo $_GET['sku'];?>" name="product_sku">
                            <select  onchange="showUserfilter(this.value)"  class="form-control " name="type" id="p2"  >
                      ...
                      <div id="txtHint">
                        ...
                        <div class="col-sm-7 controls">
                         <input type="text" value="0" class="form-control "  name="price">
