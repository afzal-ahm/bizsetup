      ...
      <div data-action="fullscreen" data-original-title="Remove Navigation Bar and Top Menu Toggle" data-toggle="tooltip" data-placement="bottom" class="fullscreen-button menu"> <i class="glyphicon glyphicon-fullscreen"></i> </div>
          ...
          <div class="vd_content-section clearfix">
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> Confirm Order Panel</h3>
                  </div>
                    ...
                    <table class="table table-striped" id="data-tables">
                      ...
                      <tbody> 
                         <?php
                          ...
                          <td><input type="checkbox" name="checkbox[]" id="checkbox[]" value="'.$ordersvalue['order_id'].'" > '.$ordersvalue['order_id'].'</td>
            ...
            <div class="row">
							...
							<div class="col-md-6">
							<td><button class="btn vd_btn vd_bg-green vd_white" type="submit" name="btn-comp"><i class="icon-ok"></i>Complete</button></td>
						 </div>
