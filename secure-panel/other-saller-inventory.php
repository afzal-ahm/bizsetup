                    ...
                    <table class="table table-striped" id="data-tables">
                     ...
                     <tbody>
                       <?php
                           ...
                           $i=1;
 $query="SELECT * from product where p_copy='1' order by id DESC";
...
foreach($imge1 as $key=> $image1)
                        ...
                        <tr>
                          ...
                          <td class=" "><b></b> <?php echo $value['sku'];?>
                          	<br>By-  <span style="color:red"><?php  if($value['type']==''){ echo 'Admin';} else { echo 'Vendor';}?></span>
                          	<br>
...
<?php  } ?> </span></td>
						 ...
						 <td class="menu-action rounded-btn"> 
						  ...
						  <a href="product-profile.php?sku=<?php echo $value['id'];?>" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a> 
						<!-- <a href="editproduct.php?sku=<?php echo $value['id'];?>" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a>  -->
						 <a href="deleteproduct.php?sku=<?php echo $value['id'];?>"   data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-times"></i> </a>
