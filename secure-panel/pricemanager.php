...
$discount = $_POST['discount'];
 ...
 $field_value=array($sku,$unitprice,$mrp,$discount);
...
?>
<script>
alert("Price Inserted");
window.location ='pricemanager.php'
</script>
<?php
}
else{
...
/* REVENUE LINE CHART */
	...
	var plot;
        plot = $.plotAnimator($("#revenue-line-chart"), [
            {
                label: "Revenue",
                data: d2,
                lines: {
...
/* REVENUE DONUT CHART */
		...
		var revenue_donut_chart;
        revenue_donut_chart = $("#revenue-donut-chart");
