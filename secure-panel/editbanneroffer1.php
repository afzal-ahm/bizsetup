...
include_once 'config.php';
 $dd="SELECT * from banner_offer where id='".$_GET['sku']."'";
...
$ty='large';
 ...
 $up="UPDATE `banner_offer` SET   `offer`='$offer',`category`='$category_name1',`subcategory`='$subcategory_name1',`sub_subcategory_name`='$sub_subcategory_name1',`date`='$date',`type`='$ty',`categoryname`='$category_name',`subcategoryname`='$sub_name',`subsubcrategoryname`='$sub_sub_name',`caturl`='$category_url',`suburl`='$sub_url',`subsuburl`='$sub_sub_url'  WHERE id='".$_GET['sku']."'";
 ...
 $image_name = $_FILES['image']['name'];
	...
	$query1 = "UPDATE banner_offer SET image='$imagename',`type`='$ty' where id='".$_GET['sku']."'";
...
$runc=mysqli_query($conn,$query1);
 ...
 echo'<script>location.assign("banner_offer1.php")</script>';
	}  }
	?>
                ...
                <div class="panel widget">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                        <img src="../images/banner/<?php echo $data['image'];?>">
