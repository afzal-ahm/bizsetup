    ...
    <div data-action="remove-navbar" data-original-title="Remove Navigation Bar Toggle" data-toggle="tooltip" data-placement="bottom" class="remove-navbar-button menu"> <i class="fa fa-arrows-h"></i> </div>
      ...
      <div data-action="fullscreen" data-original-title="Remove Navigation Bar and Top Menu Toggle" data-toggle="tooltip" data-placement="bottom" class="fullscreen-button menu"> <i class="glyphicon glyphicon-fullscreen"></i> </div>
          ...
          <div class="vd_content-section clearfix">
            <div class="row">
              <div class="col-md-12">
             <div class="col-md-6  mgbt-xs-15  mgbt-md-0">
                      ...
                      <div data-rel="scroll" data-scrollheight="259">
                        <ul class="list-wrapper pd-lr-10">
                         <li   >
                           ...
                           <?php   $sqls="select Count(*) AS total from   saller_sopport where  saller_id='".$_GET['sku']."'";
									$results=mysqli_query($conn,$sqls);
									 $mls=mysqli_fetch_array($results); 
									  ...
									  if($cous>'0')
									  { 
                                         $ss="SELECT * from saller_sopport where  saller_id='".$_GET['sku']."' order by id DESC  ";
									  	$run=mysqli_query($conn,$ss);
									  	foreach($run as $key=> $co)
									  	{
											
									 
									 if($co['bymessage']=='admin')
                                           {
                          ...
                          <li>
                            ...
                            <div class="menu-text"> <strong><?php echo $co['message'];?>:</strong> <?php echo $co['bymessage'];?>
                              <div class="menu-info"> <span class="menu-date"><?php echo $co['date'];?></span>  </div>
                            </div>
                          </li>
                            <?php } else {
                ...
                <div class="mgbt-xs-20">
                  <div class="panel widget panel-bd-top vd_bdt-yellow  light-widget">
                    ...
                    <div class="panel-body">
                      <h3>Give Response</h3>
                      <div class="content-list content-image">
                         <textarea id="msg" placeholder="Type your message here" class="form-control border-0"></textarea>
                                            </div>
                                            <input type="hidden" id="code" value="<?php echo $_GET['sku'];?>" >
                                            <input type="hidden" id="admin" value="admin" >
                                            <input type="hidden" id="bymessage" value="admin" >
                                            <div class="col-4 text-right">
                                                <button type="button"  onclick="showUserfiltercart(this.value)" value="1" class="btn btn-info btn-circle btn-lg"><i class="fa fa-paper-plane" aria-hidden="true"></i> </button>
                      </div>
                      <!-- content-list --> 
                    </div>
                  </div>
                  <!-- panel --> 
                   <script>
function showUserfiltercart(str) {
	// alert(str);
	var msg=$("#msg").val();
	//alert(id);
	var code=$("#code").val();
	var admin=$("#admin").val();
	var bymessage=$("#bymessage").val();
	 
	// alert(msg); alert(code); alert(bymessage);
    if (str == "") {
    	
        document.getElementById("txtHintcart").innerHTML = "";
        return;
    } else { 
        ...
        xmlhttp.onreadystatechange = function() {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                document.getElementById("txtHintcart").innerHTML = xmlhttp.responseText;
            }
        };
            xmlhttp.open("GET","sallerpostajex.php?msg=" +msg+ "&code=" +code+ "&admin=" +admin+ "&bymessage=" +bymessage,true);
