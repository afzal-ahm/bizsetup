...
if(isset($_POST['btn-save']))
{
    ...
    $dateto = $_POST['dateto'];
    $today = date('Y-m-d');$ff='1';
    $field_value=array($promoTitle,$promoCode,$discount,$datefrom,$dateto,$today,$ff);
    $field=array('promo_title','promo_code','discount','datefrm','dateto','doi','status');
    $res = $con->insert($field_value,$table,$field);
    if($res)
    {
        ?>
        <script>
            alert("Promocode Inserted");
                            ...
                            <div class="col-md-12">
                                <div class="panel widget">
                                    ...
                                    <div class="panel-body">
                                        <form class="form-horizontal" action="addpromo.php" method="post" role="form">
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Promo Title</label>
                                                <div class="col-sm-7 controls">
                                                    <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" name="promotitle">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Promo Code </label>
                                                <div class="col-sm-7 controls">
                                                    <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" name="promocode">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Discount </label>
                                                <div class="col-sm-7 controls">
                                                    <input class="width-70" type="number" placeholder="Input" data-toggle="tooltip" data-placement="top" name="discount">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Date From</label>
                                                <div class="col-sm-7 controls">
                                                    <input type="text" class="width-70" id="datetimepicker_dark" name="datefrom" data-rules-required="true" >
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Date To</label>
                                                <div class="col-sm-7 controls">
                                                    <input type="text" class="width-70" id="datetimepicker_darkto" name="dateto" data-rules-required="true" >
                                                </div>
                                            </div>
