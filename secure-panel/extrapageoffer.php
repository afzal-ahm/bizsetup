...
move_uploaded_file($image_tmp, "../images/banner/$imagename");
 

 
 	
  	$up="INSERT INTO `extrapage`(  `image`, `offer`, `category`, `subcategory`, `sub_subcategory_name`, `date`, `type`, `categoryname`, `subcategoryname`, `subsubcrategoryname`, `caturl`, `suburl`, `subsuburl`) VALUES ('$imagename','$offer','$category_name1','$subcategory_name1','$sub_subcategory_name','$date','$ty','$category_name','$sub_name','$sub_sub_name','$category_url','$sub_url','$sub_sub_url' )";
                ...
                <div class="panel widget">
                  ...
                  <div class="panel-body">
                          ...
                          <select class="width-40" name="type"   > 
                            <option value="">----All------</option>
										 ...
										 <option value="Grocery Store">Grocery</option> 
											 <option value="Offer Zone">offer</option> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input"  name="offer" value="" required >
                        </div>
                      </div>
