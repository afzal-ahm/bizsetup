...
<div class="vd_body">
                    ...
                    <div class="vd_content clearfix">
                        ...
                        <div class="vd_title-section clearfix">
                            <div class="vd_panel-header">
                                ...
                                <small class="subtitle">  Dashboard</small>
                            ...
                            <div class="col-md-12">
                                <div class="panel widget">
                                    <div class="panel-heading vd_bg-grey">
                                        <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Edit Admin </h3>
                                    </div>
	...
	$query = "SELECT * from service_n where id='".@$_GET['catid']."'";
	...
	$run = mysqli_query($conn, $query);
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          ...
                          <input class="width-70" type="text" placeholder="Input" value="<?php echo $dataval['service_name'];  ?>" data-toggle="tooltip" data-placement="top" name="title" >
                        </div>
                      </div>
...
$content = $_POST['content'];
 $new = $_GET['new'];
	...
	$query1 = "UPDATE service_n SET service_name='$title'  where id='".$_POST['edit_id']."'";
 ...
 echo "<script>alert('  Edit Sucessfully')</script>";
echo "<script>window.open('viewservice.php?new=$new','_self')</script>";
