 ...
 if(isset($_POST['submit']))
{
	...
	//$query="INSERT into testimonial (name,content) VALUES ('$name','$content')";
	 ...
	 $query="UPDATE top_heading set fast_free_delevery='$content1',safe_secure_payment='$content2',money_back_guarnaty='$content3' where id='2'";
...
window.location ='show_bottom.php'
</script>
<?php
}
else{
    ...
    <div data-action="remove-navbar" data-original-title="Remove Navigation Bar Toggle" data-toggle="tooltip" data-placement="bottom" class="remove-navbar-button menu"> <i class="fa fa-arrows-h"></i> </div>
      ...
      <div data-action="fullscreen" data-original-title="Remove Navigation Bar and Top Menu Toggle" data-toggle="tooltip" data-placement="bottom" class="fullscreen-button menu"> <i class="glyphicon glyphicon-fullscreen"></i> </div>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Meditreat Dashboard</h1>
              <small class="subtitle">Meditreat Dashboard</small>
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span>Footer Content for change </h3>
                  </div>
...
?>
                   ...
                   <form class="form-horizontal" action="#" method="post" name="form" role="form" enctype="multipart/form-data">
					...
					<div class="form-group">
                        <label class="col-sm-2 control-label">Footer content 1</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input" value="<?php echo $row['fast_free_delevery']; ?>" data-toggle="tooltip" data-placement="top" name="content1" > 
                        </div>
                      </div>
					  
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Footer content 2</label>
                        <div class="col-sm-7 controls">
                        
  				<input class="width-70" type="text" value="<?php echo $row['safe_secure_payment']; ?>" data-toggle="tooltip"  data-placement="top" name="content2" >
                       ...
                       <div class="form-group">
                        <label class="col-sm-2 control-label">Footer content 3</label>
                        <div class="col-sm-7 controls">
                        
  				<input class="width-70" type="text" value="<?php echo $row['money_back_guarnaty']; ?>" data-toggle="tooltip"  data-placement="top" name="content3" >
