...
include("config.php");
$table = "services"; 
$d="SELECT * from service_n where sub_sub_id='".$_GET['new']."'";
...
echo "<script>window.open('viewservice.php?new='.$name.'','_self')</script>";
?>
...
<div class="vd_body">
                                ...
                                <div class="col-md-12">
                                    <div class="panel widget">
                                        <div class="panel-heading vd_bg-grey">
                                            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> Extra Services </h3>
                                        </div>
                                        <div class="panel-body-list  table-responsive">
                                            <table class="table table-striped table-hover no-head-border">
                                                ...
                                                <tbody>
                                                <?php
                                                 $query="SELECT * from service_n where sub_sub_id='".$_GET['new']."'";
	...
	$run = mysqli_query($conn,$query);
 	...
 	<a   target="_blank"  href="add_medical.php?new='.$value['id'].'"><button type="button"   class="btn btn- btn-xs"  style="background-color: #000;color:#fff;">Add Price </button>  </a> 
 	<a   target="_blank"  href="viewmedical.php?new='.$value['id'].'"><button type="button"   class="btn btn- btn-xs"  style="background-color: #000;color:#fff;">View Price </button>  </a> 

 	</td> 
                          
							
						 <td class="menu-action rounded-btn"><a href="editservice.php?catid='.$value['id'].'&new='.$_GET['new'].'" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a> <a href="viewservice.php?del='.$value['id'].'&new='.$_GET['new'].'"    data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-times"></i> </a></td>
                        </tr>';}?>
        ...
        <div class="vd_bottom ">
            <div class="container">
                <div class="row">
                    <div class=" col-xs-12">
                        <div class="copyright">
                            Copyright &copy;2   Inc. All Rights Reserved
                        </div>
                    </div>
                </div><!-- row -->
            </div><!-- container -->
