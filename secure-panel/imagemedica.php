...
$service  = $_POST['service'];
	 ...
	 $image_tmp = $_FILES['image']['tmp_name'];    
	   ...
	   move_uploaded_file($image_tmp, "../images/service/$imagename");
	  
//$product_des = $_POST['description'];

//$product_sku = $_POST['product_sku'];
$field_value=array($section,$service,$imagename);
$field =array('section','subdervice','image');
...
<!-- vd_panel-menu --> 
  ...
  // echo $sql = "SELECT DISTINCT category FROM category";
   $query= "SELECT * from submedical";
	$run = mysqli_query($conn,$query);
		while ($row=mysqli_fetch_array($run))
   {
   	
   	?>
                             <option value="<?php echo $row['subservice'];?>"><?php echo $row['subservice'];?></option> 
                             <?php 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          ...
                          <select class="width-40" name="section">
