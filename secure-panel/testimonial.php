...
$table = "testimonial";
 ...
 if($image_name!='')
 {
	...
	$rt="INSERT INTO `testimonial`( `name`, `content`, `status`, `image`, `position`) VALUES ('$heading','$content','','$imagename','$position' )";
 $res=mysqli_query($conn,$rt);
if($res)
{
?>
<script>
                   ...
                   <form class="form-horizontal" action="#" method="post" name="form" role="form" enctype="multipart/form-data">
					...
					<div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                        <label class="col-sm-2 control-label">Add position</label>
                        <div class="col-sm-7 controls"> 
                           <textarea  class=" "  name="position" ></textarea>
                        </div>
                      </div>
