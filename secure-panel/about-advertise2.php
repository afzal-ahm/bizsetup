...
<div class="vd_body">
                ...
                <div class="vd_container">
                    <div class="vd_content clearfix">
                        ...
                        <div class="vd_title-section clearfix">
                            <div class="vd_panel-header">
                                <h1>Admin Content</h1>
                                <small class="subtitle">Admin ontent</small>
	...
	$run = mysqli_query($conn, $query);
                  ...
                  <label class="col-sm-2 control-label">User Amount :</label>
                  <div class="col-sm-8">
                      <input  type="text" name="user" value="<?php echo $dataval['user']; ?>">
                  </div>
                </div>
                
                 <div class="form-group">
                  <label class="col-sm-2 control-label">Corporate Amount :</label>
                  <div class="col-sm-8">
                      <input  type="text" name="corporate" value="<?php echo $dataval['corporate']; ?>">
                  </div>
                </div>
                  <div class="form-group">
                  <label class="col-sm-2 control-label">Courier charges :</label>
                  <div class="col-sm-8">
                      <input  type="text" name="content12" value="<?php echo $dataval['content12']; ?>">
                  </div>
                </div>
          ...
          <div class="form-group">
                  <label class="col-sm-2 control-label">About Us Image  :</label>
                  <div class="col-sm-8">
                     <img style="width: 200px" src="../images/extra/<?php echo $dataval['image']; ?>">
                  </div>
                </div>
                <!--
                   <div class="form-group">
                  <label class="col-sm-2 control-label">About Us banner Image :</label>
                  <div class="col-sm-8">
          ...
          <div class="form-group">
                  <label class="col-sm-2 control-label">About Us banner Image  :</label>
                  <div class="col-sm-8">
                     <img  style="width: 200px"  src="../images/extra/<?php echo $dataval['blog_image']; ?>">
                  </div>
                </div>
                
                <div class="form-group">
                  <label class="col-sm-2 control-label">Contact  Us banner Image :</label>
                  <div class="col-sm-8">
             ...
             <div class="form-group">
                  <label class="col-sm-2 control-label">Contact Us  banner Image   :</label>
                  <div class="col-sm-8">
                     <img style="width: 200px"  src="../images/extra/<?php echo $dataval['contact_image']; ?>">
                  </div>
                </div>
                  ...
                  <div class="form-group">
                  <label class="col-sm-2 control-label">Service page banner :</label>
                  <div class="col-sm-8">
                  ...
                  <div class="form-group">
                  <label class="col-sm-2 control-label">Service page   banner image :</label>
                  <div class="col-sm-8">
                     <img  style="width: 200px"  src="../images/extra/<?php echo $dataval['quility']; ?>">
                  </div>
                </div>-->
                      ...
                      <div class="form-group">
                  <label class="col-sm-2 control-label">About us Home  page  :</label>
                  <div class="col-sm-8">
                    <textarea  class="ckeditor"  name="content" ><?php echo $dataval['about_us']; ?></textarea>
                  </div>
                </div>
                    ...
                    <div class="form-group">
                  <label class="col-sm-2 control-label">About us Footer  page  :</label>
                  <div class="col-sm-8">
                    <textarea  class="ckeditor"  name="address1" ><?php echo $dataval['address1']; ?></textarea>
                  </div>
                </div>
                    ...
                    <div class="form-group">
                  <label class="col-sm-2 control-label">Term & Condition  :</label>
                  <div class="col-sm-8">
                    <textarea  class="ckeditor"  name="ship" ><?php echo $dataval['ship']; ?></textarea>
                  </div>
                </div>
                    ...
                    <div class="form-group">
                  <label class="col-sm-2 control-label">Privcay Policy  :</label>
                  <div class="col-sm-8">
                    <textarea  class="ckeditor"  name="privacy_policy" ><?php echo $dataval['privacy_policy']; ?></textarea>
                  </div>
                </div>
                  ...
                  <div class="col-sm-8">
                    <textarea  class="ckeditor"  name="support" ><?php echo $dataval['support']; ?></textarea>
                  </div>
                </div>
                    ...
                    <div class="form-group">
                  <label class="col-sm-2 control-label">Google Tag/ Api in header of every page  :</label>
                  <div class="col-sm-8">
                    <textarea  class=" "  row="6" name="payment" ><?php echo $dataval['payment']; ?></textarea>
                  </div>
                </div>
                    ...
                    <div class="form-group">
                  <label class="col-sm-2 control-label">Tag/ Api After body tag in every page  :</label>
                  <div class="col-sm-8">
                    <textarea  class=" "  row="6"  name="shippingpage" ><?php echo $dataval['shippingpage']; ?></textarea>
                  </div>
                </div>
                  ...
                  <div class="col-sm-8">
                   <input  type="text" name="quilityp" value="<?php echo $dataval['quilityp']; ?>">
                      ...
                      <div class="form-group">
                  <label class="col-sm-2 control-label">  home page content    :</label>
                  <div class="col-sm-8">
                   <input  type="text" name="term" value="<?php echo $dataval['term']; ?>">
                 ...
                 <div class="form-group">
                  <label class="col-sm-2 control-label">Socail Facebook :</label>
                  <div class="col-sm-8">
                  <input  type="text" name="link1" value="<?php echo $dataval['link1']; ?>">
                   
                  </div>
                </div>
                
                 <div class="form-group">
                  <label class="col-sm-2 control-label">Socail Google :</label>
                  <div class="col-sm-8">
                     <input  type="text" name="link2" value="<?php echo $dataval['link2']; ?>">
                  </div>
                </div>
                
                 <div class="form-group">
                  <label class="col-sm-2 control-label">Socail Twitter :</label>
                  <div class="col-sm-8">
                      <input  type="text" name="link3" value="<?php echo $dataval['link3']; ?>">
                  </div>
                </div>
                 <div class="form-group">
                  <label class="col-sm-2 control-label">Socail Linkdin :</label>
                  <div class="col-sm-8">
                      <input  type="text" name="link4" value="<?php echo $dataval['link4']; ?>">
                  </div>
                </div>
...
{ 
	...
	$term=$_POST['term'];
	$privacy=$_POST['privacy_policy'];$ship=$_POST['ship'];
	$support=$_POST['support'];
	$payment=$_POST['payment'];
	$security='';  
	
	$link1=$_POST['link1'];  $address1=$_POST['address1'];  $address2=$_POST['address2'];  $quilityp=$_POST['quilityp'];  
	$link2=$_POST['link2'];  
	$link3=$_POST['link3'];  
	$link4=$_POST['link4'];  $invoice='';  
	
	
 
	 $shippingpage=$_POST['shippingpage'];
	  $disc='';  
	   $returnpolicy='';  
	  $content = mysqli_real_escape_string($conn,$content);
	  $term = mysqli_real_escape_string($conn,$term);
	  $quilityp = mysqli_real_escape_string($conn,$quilityp);
 
     $address1 = mysqli_real_escape_string($conn,$address1);
     $link1 = mysqli_real_escape_string($conn,$link1);
     $link2 = mysqli_real_escape_string($conn,$link2);
     $link3 = mysqli_real_escape_string($conn,$link3);
     $link4 = mysqli_real_escape_string($conn,$link4);
     
     
     $payment = mysqli_real_escape_string($conn,$payment);
     
     $shippingpage = mysqli_real_escape_string($conn,$shippingpage);
   ...
   if($image_name!=''){
 	 ...
 	 $image_tmp = $_FILES['image']['tmp_name'];    
 	   ...
 	   move_uploaded_file($image_tmp, "../images/extra/$imagename");
 	    ...
 	    $query1 = "UPDATE contact_info SET image='$imagename'    where id='1'";
      $me=mysqli_query($conn,$query1);
 	  }
 	  
	 
 	   $query1 = "UPDATE contact_info SET   shippingpage='$shippingpage' ,payment='$payment' ,user='$user' ,content12='$content12' , corporate='$corporate' , about_us='$content' , term='$term',privacy_policy='$privacy',ship='$ship' ,support='$support',payment='$payment' ,link1='$link1',link2='$link2',link3='$link3',link4='$link4',invoice='$invoice',shippingpage='$shippingpage',disc='$disc',returnpolicy='$returnpolicy' ,address1='$address1',address2='$address2' ,quilityp='$quilityp' where id='1'";
  ...
  echo "<script type=\"text/javascript\">".
        ...
        "</script>";
 echo'<script>location.assign("about-advertise2.php")</script>';
}
?>  
