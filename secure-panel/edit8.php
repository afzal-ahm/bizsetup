...
if($image_type=="image/jpeg" or $image_type=="image/png" or $image_type=="img/gif"){
	if ($image_size<=5000000){
  	move_uploaded_file($image_tmp, "../images/top service/$image_name");
	}
	else{
		echo "<script>alert('larger image size')</script> ";
		}
	}
...
//$query="INSERT into new_products (img,content) VALUES ('$image_name','$terms')";

$query="UPDATE  newheadlines SET img='$image_name', content='$terms' where id='".$_POST['edit_id']."'";
	// $query = "UPDATE term_condition SET about='$terms', img='$image_name' WHERE id='1' ";
	 	 $me=mysqli_query($conn,$query);
	 	 }

elseif($_FILES['image']['name'] ==""){
	$query="UPDATE  newheadlines SET  content='$terms' where id='".$_POST['edit_id']."'";
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Add Circle Images/ Data</h3>
                  </div>
...
$query="SELECT * FROM  newheadlines where id='".@$_GET['edit']."'";
...
?>
					...
					<div class="form-group">
                        <label class="col-sm-2 control-label">Add Circle Images</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="file"  data-toggle="tooltip" data-placement="top" name="image" >
                           <p>Images Size Should be "width="45 pixels" height="45 pixels" ".   </p>
                        </div>
                         <div class="col-sm-3 controls">
                        <img src="../images/top service/<?php echo $image; ?>" width="80" height="80" >
                         <input type="hidden" class="form-control" placeholder="" name="edit_id" value="<?php echo $_GET['edit']; ?>">
                        </div>
                       
                      </div>
					  
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Circle Data</label>
                      
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" value="<?php echo $content; ?>" data-toggle="tooltip" data-placement="top" name="terms" >
                        </div>
                      </div>
