              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> view  prescription Panel</h3>
                  </div>
                    ...
                    <table class="table table-striped" id="data-tables">
                     ...
                     <tbody>
                       <?php
                           ...
                           $i=1;
 $query="SELECT * from prescription_order order by id DESC";
	...
	$run = mysqli_query($conn,$query);
					   foreach($run as $ke=>$value){
                        ...
                        <tr>
                          ...
                          <td class=" "><b></b> <?php echo $value['city'];?><br> <?php echo $value['pincode'];?><br> <?php echo $value['address'];?><br></td>
                          <td class=" ">  <?php echo $value['date'];?> </td>
                           <td class=" ">  <?php echo $value['message'];?> </td>
                           <td class=" ">  <a target="_blank" href="../images/prescription/<?php echo $value['file'];?>"> view file</a> <br></td>
                          <td class=" ">  <a target="_blank" href="createorder.php?id=<?php echo $value['id'];?>&ema=<?php echo $value['email'];?>"> Create Order</a> <br></td>
