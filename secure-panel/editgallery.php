...
<div class="vd_body">
    ...
    <div class="content">
	 ...
	 $query = "SELECT * from logo where id='".@$_GET['catid']."'";
...
<div class="form-group">
                  ...
                  <div class="col-sm-8">
                   <img src="../images/<?php echo $dataval['img']; ?>"width="50px">
                  </div>
                </div>
...
<div class="form-group">
	...
	<div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70"   type="text" placeholder="Input" data-toggle="tooltip" value="<?php echo $dataval['heading']; ?>" data-placement="top" name="heading" >
                        </div>
                      </div>
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70"   type="text" placeholder="Input" data-toggle="tooltip"  value="<?php echo $dataval['link']; ?>" data-placement="top" name="link" >
                        </div>
                      </div>
...
if($image_name!='')
{
	 ...
	 $image_tmp = $_FILES['image']['tmp_name'];    
	   ...
	   move_uploaded_file($image_tmp, "../images/$imagename");
	 	...
	 	$query1 = "UPDATE logo SET img='$imagename' where id='".$_POST['edit_id']."'";
 	$me=mysqli_query($conn,$query1);
}
	$query1 = "UPDATE logo SET heading='$heading',link='$link' where id='".$_POST['edit_id']."'";
 ...
 echo'<script>location.assign("gallery.php")</script>';
