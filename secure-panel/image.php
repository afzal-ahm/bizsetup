...
$field_value=array($sku,$imagename);
$field =array('pro_sku','pro_img');
                    ...
                    <form class="form-horizontal" enctype="multipart/form-data" action="" role="form" method="post">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input"  name="product_sku" required>
                        </div>
                      </div>
