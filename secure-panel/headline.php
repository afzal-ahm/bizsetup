                  ...
                  <div class="panel-body">
                    <form class="form-horizontal" action="#" method="post" role="form" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Add headline </label>
                        <div class="col-sm-7 controls">
                         <textarea class="width-70" type="text" placeholder="Input" rows="5" data-toggle="tooltip" data-placement="top" name="content"> </textarea>
                        </div>
                      </div>
...
$query="INSERT into top_heading (content) VALUES('$content')";
	 //$query = "UPDATE top_heading SET content='$terms', img1='$image_name' ";
