          ...
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li class="active"> View Pincode</li>
              </ul>
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> view  Pincode Panel
	...
	$run = mysqli_query($conn,$query);
					   foreach($run as $ke=>$value){
                        ...
                        <tr>
                          ...
                          <td> <?php echo $value['oda'] ;?>  </td>
                           <td> <?php echo $value['city'] ;?>  </td>
                            <td> <?php echo $value['state'] ;?>  </td>
                            <td> <?php echo $value['capability'] ;?>  </td>
        ...
        <a href="action1pincode.php?status=<?php echo $value['id'];?>" class="label label-danger " onclick="return confirm('Activate <?php echo $data?>');"> NOT </a>
<?php  }
if($value['status']=='1'){?>
<a href="action1pincode.php?status=<?php echo $value['id'];?>" 
