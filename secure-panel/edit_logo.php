...
<div class="vd_body">
	...
	$query = "SELECT * from logo1 where id='".@$_GET['id']."'";
	...
	$run = mysqli_query($conn, $query);
                        ...
                        <div class="col-sm-7 controls">
                          <img src="../images/<?php echo $dataval['img'];  ?>" height="60" width="60">
                        </div>
                                      ...
                                      <?php  if(isset($_POST['update']))
{
	...
	$query1 = "UPDATE logo1 SET img='$imagename' where id='".$_POST['edit_id']."'";
