...
if($image_type=="image/jpeg" or $image_type=="image/png" or $image_type=="img/gif"){
	if ($image_size<=5000000){
  	move_uploaded_file($image_tmp, "../images/logo/$image_name");
	}
	else{
...
//$query="INSERT into logo (img) VALUES ('$image_name')";
 $query = "UPDATE logo SET img='$image_name' WHERE id='1' ";
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Add LOGO </h3>
                  </div>
