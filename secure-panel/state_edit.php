 ...
 if(isset($_POST['submit']))
{
	...
	//$query="INSERT into testimonial (name,content) VALUES ('$name','$content')";
	 ...
	 $query="UPDATE states set name='$name',price='$content'  where id='".$_POST['edit_id']."'";
...
window.location ='viewclient.php'
</script>
<?php
}
else{
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> name </h3>
                  </div>
...
$query="SELECT * FROM states where id='".@$_GET['edit']."'";
...
?>
                   ...
                   <form class="form-horizontal" action="#" method="post" name="form" role="form" enctype="multipart/form-data">
					...
					<div class="form-group">
                        <label class="col-sm-2 control-label">Edit State</label>
                        <div class="col-sm-7 controls">
                           <input class="width-70" type="text" placeholder="Input" value="<?php echo $name; ?>" data-toggle="tooltip" data-placement="top" name="name" >
                 ...
                 <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input" value="<?php echo $content; ?>" data-toggle="tooltip" data-placement="top" name="content" > 
                        </div>
                      </div>
