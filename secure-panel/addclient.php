...
$sel="INSERT into  states (name,country_id,price) VALUES('$title','101','$content')";
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span>     Manager </h3>
                  </div>
                  <div class="panel-body">
                   ...
                   <div class="form-group">
                        <label class="col-sm-2 control-label">Title of Slider</label>
                        <div class="col-sm-7 controls">
                         
                          <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" name="title" >
                        </div>
                      </div>
                
					  <div class="form-group">
                        <label class="col-sm-2 control-label">Content of slider</label>
                        <div class="col-sm-7 controls">
                         
                          <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" name="content" >
                        </div>
                      </div>
					  ...
					  --> 
					    <div class="form-group">
                        <label class="col-sm-2 control-label">Add   State</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" name="title" >
                        </div>
                       </div>
                        <div class="form-group">
                        <label class="col-sm-2 control-label">Add   State Price</label>
                        <div class="col-sm-7 controls">
