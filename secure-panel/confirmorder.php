...
//$Orders=$con->selectcatprod($table,$field_value,$field);
                        ...
                        //   $i=1;
 $query="SELECT * from order_summary where process_type='confirm' order by id DESC";
...
if(isset($_POST['btn-comp'])){
    $order_id=implode('\',\'',$_POST['checkbox']);
  // echo  $feed=implode('\',\'',$_POST['feedback']);
    		//$feed=$_POST['feedback'];
        $table = 'order_summary';
                    ...
                    <div class="vd_content clearfix">
                        <div class="vd_title-section clearfix">
                            <div class="vd_panel-header">
                                <h1>Confirm Order Panel</h1>
                                <small class="subtitle">List of Orders</small> </div>
                        </div>
                        <div class="vd_content-section clearfix">
                          ...
                          <td width="40px"><input type="checkbox" name="checkbox[]" id="checkbox[]" value="'.$ordersvalue['order_id'].'" > '.$ordersvalue['order_id'].'</td>
						  <td>'.$ordersvalue['total_amount'].'</td>
						  <td>'.$ordersvalue['mobile_no'].'</td>
						  <td>'.$ordersvalue['email_id'].'</td>
						  <td>'.$ordersvalue['order_date'].'</td>
						  <td>'.$ordersvalue['payment_type'].'</td>
						   <td><span class="label label-success">'.$ordersvalue['process_type'].'</span></td>
						   <td><a href="status.php?id='.$ordersvalue['order_id'].'"><span class="label label-danger">Add status</span></a></td>
						  </tr>';}?>

                                                </tbody>
                                            </table>
                                               <button class="btn vd_btn vd_bg-green vd_white" type="submit" name="btn-comp"><i class="icon-ok"></i>Complete</button>
                                               </form>
                                        </div>
                                    </div>
                                    <!-- Panel Widget -->
                                    <ul class="pagination">
                                        ...
                                        <li style="border-radius: " class="active"><a href="#">1</a></li>
                                        <li><a href="#">2</a></li>
                                        <li><a href="#">3</a></li>
                                        <li><a href="#">4</a></li>
                                        <li><a href="#">5</a></li>
