          ...
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li class="active"> View Pop up Contects</li>
              </ul>
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> view Pop up Contects</h3>
                  </div>
                  <div class="panel-body table-responsive">
                    <table class="table table-striped" id="data-tables">
                      ...
                      <tbody>
                        <?php 
                           $i=1;
 $query="SELECT * from pop_up order by id DESC";
...
?>               	
                 ...
                 <!--     <td> <span ><button class="<?php if(($row['status'])=='0') {echo 'label label-danger'; } else{ echo 'label label-success';};?>" onclick="return confirm('Are you shure?')"><?php if(($row['status'])=='0')
{
?>
<a style="color :#ffffff;" href="action2.php?status=<?php echo $row['id'];?>" 
 onclick="return confirm('Activate <?php echo $data?>');">  Cancel </a>
<?php
}
if($row['status']=='1')
{
?>
<a style="color :#ffffff;" href="action2.php?status=<?php echo $row['id'];?>" 
  onclick="return confirm('De-activate <?php echo $data?>');"> Confirm</a>
<?php
} ?> </button></td> -->
            ...
            <div class="row">
							...
							<div class="col-md-6">
							<td><button class=" " onclick="return confirm('Are you shure?')"><a href="download1.php" class="deact btn btn-success " > Confirm appointment</a>
 </button></td>
						 </div>
						 <div class="col-md-6">
							<td><button  onclick="return confirm('Are you shure?')"><a href="download.php?" class="deact btn btn-danger "> Cancel appointment</a>
 </button></td>
						 </div>
                         </tr>
