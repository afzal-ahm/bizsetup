...
$Date = date('Y-m-d');
$field_value = array($Date);
$field = array('ondate','fname','mname','lname','mobile_no','email','address','city','pincode','customer_user_id');
                    ...
                    <div class="vd_content clearfix">
                        <div class="vd_title-section clearfix">
                            <div class="vd_panel-header">
                                <h1>User Panel</h1>
                                <small class="subtitle">List of Users</small> </div>
                        </div>
                        <div class="vd_content-section clearfix">
						 ...
						 <td class="menu-action rounded-btn"><a href="userprofile.php?cusid='.$value['customer_user_id'].'" data-original-title="view" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-eye"></i> </a> <a href="edituser.php?cusid='.$value['customer_user_id'].'" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a> <a href="deleteuser.php?cusid='.$value['customer_user_id'].'"   data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-times"></i> </a></td>
                        </tr>';}?>
