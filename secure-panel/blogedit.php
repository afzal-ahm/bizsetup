...
if(isset($_GET['catid'])){
    ...
    $field=array('id','image','content','author','title');
...
$query="update blog set title='$title',content='$content'  where id='$catid'";
...
<div class="vd_body">
                ...
                <div class="vd_container">
                    <div class="vd_content clearfix">
                        ...
                        <div class="vd_title-section clearfix">
                            <div class="vd_panel-header">
                                <h1>Edit Service Dashboard</h1>
                                <small class="subtitle">Edit Service Dashboard</small>
                            ...
                            <div class="col-md-12">
                                <div class="panel widget">
                                    <div class="panel-heading vd_bg-grey">
                                        <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Edit Service </h3>
                                    </div>
                                        ...
                                        <form class="form-horizontal" action="" method="post" role="form" enctype="multipart/form-data">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7 controls">
                                                    <input class="width-70" type="text" value="<?php echo $dataval['title']; ?>" data-toggle="tooltip" data-placement="top" name="title">
                                                </div>
                                            </div>
 ...
 <div class="form-group">
                                                ...
                                                <div class="col-sm-7 controls">
                                                    <input class="width-70" type="text" value="<?php echo $dataval['content']; ?>" data-toggle="tooltip" data-placement="top" name="content">
                                                </div>
                                            </div>
