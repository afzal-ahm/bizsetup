...
<div class="vd_body">
	...
	$query = "SELECT * from submedical where id='".@$_GET['catid']."'";
	...
	$run = mysqli_query($conn, $query);
     ...
     <input type="text" value="<?php echo $dataval['subservice'];  ?>" name="sub">                   </div>
                      </div>
                       ...
                       <textarea class="ckeditor" id="" cols="70" name="content" rows="20" ">   <?php echo $dataval['content'];  ?>                                 		
                                    	</textarea>
                        </div>
                      </div>
...
echo	$query1 = "UPDATE submedical SET subservice='$sub' , content='$content' where id='".$_POST['edit_id']."'";
 ...
 echo'<script>location.assign("viewsubmedical.php")</script>';
