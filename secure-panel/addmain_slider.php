...
$image_name = $_FILES['image']['name'];
	 ...
	 $random_digit=rand(0000,9999);
	  ...
	  move_uploaded_file($image_tmp,"../images/slider/$imagename");

$sel="INSERT into  mainslider (image,status,heading1,heading2,content,link,amount,color) VALUES('$imagename','1','$heading1','$heading2','$content','$link','$amount','$color')";
...
<script>
alert("Slider Added");
window.location ='viewmain_slider.php'
</script>
<?php
}
else{
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  ...
                  <div class="panel-body">
                    <form class="form-horizontal" action="addmain_slider.php" role="form" method="post" enctype="multipart/form-data">
                   ...
                   <div id="dvPassport">  
					   ...
					   <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          ...
                          <input class="width-70" type="file" placeholder="Input" data-toggle="tooltip" data-placement="top" name="image" >
                        </div>
                      </div>
                      
                       <div class="form-group">
                        <label class="col-sm-2 control-label">Add heading First line</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder=" "  name="heading1" required> 
                        </div>
                      </div>
                        <div class="form-group">
                        <label class="col-sm-2 control-label">Add heading Second line</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder=" "  name="heading2" required> 
                        </div>
                      </div>
                      
                       <div class="form-group">
                        <label class="col-sm-2 control-label">Add Content third line</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder=" "  name="content" required> 
                        </div>
                      </div>
                      
                      
                       <div class="form-group">
                        <label class="col-sm-2 control-label">Add Link</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder=" "  name="link" required> 
                        </div>
                      </div>
                      
                       
                       <div class="form-group">
                        <label class="col-sm-2 control-label">Add amount</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder=" "  name="amount" required> 
                        </div>
                      </div>
                      ...
                      <!--
                       <div class="form-group">
                        <label class="col-sm-2 control-label">Click on square Line to get color list for slider background</label>
                        <div class="col-sm-7 controls">
                          <label for="colorPicker">Choose a color:</label>
<input type="color" value="#e0ffee" id="colorPicker">

<textarea name="color" style="    height: 31px;
    width: 10px;" type="text" value="" id="colorCode"></textarea>

<b>Current color code: <code id="colorCode"></code></b>
<buttonx  class="btn"><span style="width: 50px;height:50px;">Sample</span></buttonx>
...
const body = document.querySelector("buttonx");
    ...
    <div class="vd_bottom ">
        <div class="container">
            <div class="row">
              <div class=" col-xs-12">
                <div class="copyright">
                  	Copyright &copy;2019 Admin Inc. All Rights Reserved
                </div>
              </div>
            </div><!-- row -->
        </div><!-- container -->
