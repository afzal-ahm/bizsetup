...
<div class="vd_body">
    ...
    <div class="content">
                            ...
                            <div class="col-md-12">
                                <div class="panel widget">
                                    <div class="panel-heading vd_bg-grey">
                                        <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Fosso Saller </h3>
                                    </div>
	 ...
	 $query = "SELECT * from contact_info1 where id='1'";
...
<div class="form-group">
                  <label class="col-sm-2 control-label">About us page  :</label>
                  <div class="col-sm-8">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea  class="ckeditor"  name="term" ><?php echo $dataval['term']; ?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Privacy Policy:</label>
                  <div class="col-sm-8">
                    <textarea   class="ckeditor"  name="privacy" ><?php echo $dataval['privacy_policy']; ?></textarea>
                  </div>
                </div> 
                <div class="form-group">
                  <label class="col-sm-2 control-label">Cancellation & Return:</label>
                  <div class="col-sm-8">
                    <textarea   class="ckeditor"   name="ship" ><?php echo $dataval['ship']; ?></textarea>
                         ...
                         <div class="form-group">
                  <label class="col-sm-2 control-label">Support page:</label>
                  <div class="col-sm-8">
                    <textarea   class="ckeditor"   name="support" ><?php echo $dataval['support']; ?></textarea>
                  </div>
                </div>
                 <div class="form-group">
                  <label class="col-sm-2 control-label">Payment Page:</label>
                  <div class="col-sm-8">
                    <textarea   class="ckeditor"   name="payment" ><?php echo $dataval['payment']; ?></textarea>
                  </div>
                </div>
                 <div class="form-group">
                  <label class="col-sm-2 control-label">Security page:</label>
                  <div class="col-sm-8">
                    <textarea   class="ckeditor"   name="security" ><?php echo $dataval['security']; ?></textarea>
                  </div>
                </div>
                
                  <div class="form-group">
                  <label class="col-sm-2 control-label">Shipping page:</label>
                  <div class="col-sm-8">
                    <textarea   class="ckeditor"   name="shippingpage" ><?php echo $dataval['shippingpage']; ?></textarea>
                  </div>
                </div>
                
                  <div class="form-group">
                  <label class="col-sm-2 control-label">Disclimer page:</label>
                  <div class="col-sm-8">
                    <textarea   class="ckeditor"   name="disc" ><?php echo $dataval['disc']; ?></textarea>
                  </div>
                </div>
                
                  <div class="form-group">
                  <label class="col-sm-2 control-label">Return Policy page:</label>
                  <div class="col-sm-8">
                    <textarea   class="ckeditor"   name="returnpolicy" ><?php echo $dataval['returnpolicy']; ?></textarea>
                  </div>
                </div>
                                      ...
                                      <?php  if(isset($_POST['update']))
{
	...
	$term=$_POST['term'];
	$privacy=$_POST['privacy'];$ship=$_POST['ship'];
...
//	   move_uploaded_file($image_tmp, "../images/$imagename");
 	...
 	$query1 = "UPDATE contact_info1 SET about_us='$content' , term='$term',privacy_policy='$privacy',ship='$ship' ,support='$support',payment='$payment',security='$security' ,shippingpage='$shippingpage',disc='$disc',returnpolicy='$returnpolicy' where id='1'";
 ...
 echo "<script type=\"text/javascript\">".
        ...
        "</script>";
echo'<script>location.assign("about-advertisesaller.php")</script>';}
?>  
