                                    ...
                                    <div class="panel-body datesec" id="datesec">
                                        <?php
                                            ...
                                            $table = "attributemanager";
                                               $sel="SELECT * from attributemanager where id='".$_GET['edit']."'";
                                                $result=mysqli_query($conn,$sel);
                                                
                                            
                                            foreach($result as $keyresult =>$valresult)
                                        
											  $dd=	$valresult['description'];
											   $price=	$valresult['price'];
											 
                                                
                                            ?>
                                            <form class="form-horizontal" action="<?php $_SERVER['PHP_SELF'] ?>" method="post" role="form" enctype="multipart/form-data">
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">content</label>
                                                    <div class="col-sm-7 controls">
                          <input class="width-70" type="text"   data-toggle="tooltip" data-placement="top" name="description" value="<?php echo $dd;?>">
                                                         

                                                        <input type="hidden" class="width-40" name="id" value="<?php echo $id; ?> " >
                                                    </div>
                                                </div>
                                                 <div class="form-group">
                                                    <label class="col-sm-2 control-label">price  "leave blank no price"</label>
                                                    <div class="col-sm-7 controls">
                              <input class="width-70" type="text"  data-toggle="tooltip" data-placement="top" name="price" value="<?php echo $price;?>">
                                                ...
                                                <button class="btn vd_btn vd_bg-green vd_white" type="submit" name="btn-edit"><i class="icon-ok"></i> Save</button>
                                         ...
                                         <?php  if(isset($_POST['btn-edit']))
{
	...
	$query1 = "UPDATE attributemanager SET description='$description' , price='$price'  where id='".$id."'";
 ...
 echo "<script type=\"text/javascript\">".
        ...
        "</script>";
echo'<script>location.assign("viewproductattribute.php")</script>';}
?>  
