	...
	$run = mysqli_query($conn,$query);
					   foreach($run as $ke=>$value){
                        ...
                        <tr>
                          ...
                          <td><a target="_blank"><?php echo $value['product_name'] ;?></a>
                          
                          </td>
                          <td class=" "><b></b> Category : <?php echo $value['category'] ;?>
                          <br> Sub Category : <?php echo $value['subcategory'] ;?>
                           <br> Service name  : <?php echo $value['subsubcategory'] ;?>
                          </td>
