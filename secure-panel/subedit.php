...
<div class="vd_body">
	...
	$query = "SELECT * from sub_service where id='".@$_GET['catid']."'";
                                      ...
                                      <?php  if(isset($_POST['update']))
{
	...
	$query1 = "UPDATE sub_service SET subservice='$sub' where id='".$_POST['edit_id']."'";
 ...
 echo'<script>location.assign("viewsubservice.php")</script>';
