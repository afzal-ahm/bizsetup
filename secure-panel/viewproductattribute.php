...
$result = $con->select($table);
 $color=$_GET['color'];
if($color!="")
 {

$del="DELETE FROM `attributemanager` WHERE id='".$color."'";
$r=mysqli_query($conn,$del);
if($r)
{
	
 echo '<script>window.location.assign("viewproductattribute.php")</script>'; 
}
                                    ...
                                    <div class="panel-body datesec" id="datesec">
                                        <?php
                                            ...
                                            <table class="table table-striped table-hover no-head-border">
                                                <tr>
                                                    <th height="40" scope="col">SR.NO</th>
                                                ...
                                                <?php
                                                $i = 1;
                                                foreach($result as $key =>$valattr){
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $i ;?></td>
                                                       
                                                        
                                                        <td><?php echo $valattr['attributes'] ;?></td>
                                                        <td><?php echo $valattr['description'] ;?></td>
                                                        
                                                        
                                                        <td class="menu-action">  <a href="viewproductattribute.php?color=<?php echo $valattr['id']; ?>" data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bd-red vd_red  confirmation"> <i class="fa fa-times"></i> </a></td>
                                                    </tr>
                                                <?php $i++ ; }?>
