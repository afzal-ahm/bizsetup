...
<div class="vd_body">
                            ...
                            <div class="col-md-12">
                                <div class="panel widget">
                                    <div class="panel-heading vd_bg-grey">
                                        <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Edit Brands </h3>
                                    </div>
	...
	$query = "SELECT * from brands where id='".@$_GET['catid']."'";
	...
	$run = mysqli_query($conn, $query);
                        ...
                        <div class="col-sm-7 controls">
                          <img src="../images/brands/<?php echo $dataval['image'];  ?>" height="60" width="60">
                        </div>
                      
                      </div>
                      
                        <div class="form-group">
                        <label class="col-sm-2 control-label">Update Brand Name</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" name="link" value="<?php echo $dataval['title'] ;?>" >
                        </div>
                                      ...
                                      <?php  if(isset($_POST['update']))
{
	...
	$query1 = "UPDATE brands SET image='$imagename' where id='".$_POST['edit_id']."'";
    move_uploaded_file($image_tmp, "../images/brands/$imagename");
   $me=mysqli_query($conn,$query1);
	}
 
 $link=$_POST['link'];
	$query1 = "UPDATE brands SET title='$link' where id='".$_POST['edit_id']."'";
 
$me=mysqli_query($conn,$query1);



 echo'<script>location.assign("viewbrands.php")</script>';
