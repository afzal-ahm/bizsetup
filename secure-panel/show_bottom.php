...
?>
                          ...
                          <td class="center"><?php echo $row['fast_free_delevery']; ?></td>
                          <td class="center"><?php echo $row['safe_secure_payment']; ?></td>
                           <td class="center"><?php echo $row['money_back_guarnaty']; ?></td>
                          
                       
  <td class="center"><a href="edit_content.php"class=" btn btn-success btn-rounded">Edit</a></td>
