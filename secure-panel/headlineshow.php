...
?>
                          ...
                          <td class="center"><?php echo $content; ?></td>
                          <td class="center"><a href="edit7.php?edit=<?php echo $id; ?> "class=" btn btn-success btn-rounded">edit</a></td>
  <td class="center"><a href="del7.php?del=<?php echo $id; ?> "class=" btn btn-danger btn-rounded">Delete</a></td>
