...
include_once 'config.php';
 $dd="SELECT * from extrapage where id='".$_GET['sku']."'";
...
$ty='large';
 ...
 $image_name = $_FILES['image']['name'];
	...
	$query1 = "UPDATE extrapage SET image='$imagename',`type`='$ty' where id='".$_GET['sku']."'";
