...
$table = "product";$ac='';
    ...
    $up="UPDATE `product` SET  `mrp`='$product_price', `offer_amount`='$productprice2',`offer`='$product_offer2',`stock`='$stock'  WHERE sku='".$_POST['sku1']."'";
...
$co=$_POST['sku1'];
  ...
  $zz='asd';
  	$ds='<meta http-equiv="Refresh" content="2;url=add-product-images.php?sku='.$co.'">' ;
//echo'<script>location.assign("add-product-images.php?sku='.$co.'")</script>';
	}  }
?>
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-magic"></i> </span> Add Product </h3>
                  </div>
                    ...
                    <form class="form-horizontal" action="" method="post" role="form">
                      <div id="wizard-2" class="form-wizard">
                        <ul>
                          ...
                          <li  class="active"><a href="#tab24" data-toggle="tab">  <div class="menu-icon"> 4 </div> Price/Offer </a></li>
  ...
  <?php } ?>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-5 controls">
                                <input type="text" name="product_price"   required class="  input-border-btm">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-2 control-label">Offer Price</label>
                              <div class="col-sm-5 controls">
                              <input type="text" name="product_offer"   required class="  input-border-btm">
                             ...
                             <div class="form-group">
                              ...
                              <div class="col-sm-5 controls">
                              <input type="text" name="stock"   required class="  input-border-btm">
                        ...
                        <label class="col-sm-2 control-label"> </label>
                        <div class="col-sm-7 controls">
                          <button class="btn btn-primary" type="submit" name="btn-save">Submit <span class="menu-icon"><i class="fa fa-fw fa-chevron-circle-right"></i></span></button>
                        </div>
                      </div>
                          </div>
