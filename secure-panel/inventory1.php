	...
	$run = mysqli_query($conn,$query);
					   foreach($run as $ke=>$value){
                        ...
                        <tr>
                          ...
                          <td class="center"><b></b> <?php echo $value['brand_name'];?></td>
                         
						  <td class="center"><b>%</b> <?php echo $value['unit_price'];?></td>
						  <td class="center"><b></b> <?php echo $value['discount'];?></td>
                         
						  <td class="center"><b>$</b> <?php echo $value['mrp'];?></td>
...
?>
<a href="action1.php?status=<?php echo $value['id'];?>" 
 class="deact btn btn-success " onclick="return confirm('De-activate <?php echo $data?>');"> Slider</a>
<?php
} ?> </button></td>
