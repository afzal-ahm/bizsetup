...
<div class="vd_body">
	...
	$query = "SELECT * from mainslider where id='".@$_GET['catid']."'";
	...
	$run = mysqli_query($conn, $query);
                        ...
                        <label class="col-sm-2 control-label">Update slider Image</label>
                        ...
                        <div class="col-sm-7 controls">
                          <img src="../images/slider/<?php echo $dataval['image'];  ?>" height="60" width="60">
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder=" "  name="heading1" value="<?php echo $dataval['heading1'];  ?>" required> 
                        </div>
                      </div>
                        <div class="form-group">
                        <label class="col-sm-2 control-label">Add heading Second line</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder=" "  name="heading2" value="<?php echo $dataval['heading2'];  ?>" required> 
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder=" "  name="content" value="<?php echo $dataval['content'];  ?>" required> 
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder=" "  name="link" value="<?php echo $dataval['link'];  ?>" required> 
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder=" "  name="amount" value="<?php echo $dataval['amount'];  ?>" required> 
                        </div>
                      </div>
                      ...
                      <!--
                                  ...
                                  <div class="form-group">
                                                ...
                                                <div class="col-md-7 controls">
                                                 ...
                                                 HEX value: <input id="chosen-value" name="color" value="<?php echo $dataval['color'];  ?>">
                                                </div>
                                            </div> 
                       -->
                                      ...
                                      <?php  if(isset($_POST['update']))
{
	...
	$query1 = "UPDATE mainslider SET image='$imagename' where id='".$_POST['edit_id']."'";
...
$gg='#';
$color=$gg.$color;
 	$query1 = "UPDATE mainslider SET heading1='$heading1', heading2='$heading2', content='$content', link='$link', amount='$amount', color='$color'  where id='".$_POST['edit_id']."'";
 
$me=mysqli_query($conn,$query1);



  echo'<script>location.assign("viewmain_slider.php")</script>';
