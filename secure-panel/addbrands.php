...
$sel="INSERT into  brands (image,title,date) VALUES('$imagename','$content','".date('d-m-Y')."')";
...
<script>
alert("Brand Added");
window.location ='viewbrands.php'
</script>
<?php
}
else{
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Main Brand Manager </h3>
                  </div>
