                    ...
                    <table class="table table-striped"  >
                     ...
                     <tbody>
                       <?php
                           ...
                           $i=1;
 $query="SELECT * from allbannerhome     order by id ASC";
	...
	$run = mysqli_query($conn,$query);
					   foreach($run as $ke=>$value){
                        ...
                        <tr>
						    ...
						    <td class=" "><b></b>Page : <b style="color:red;"><?php echo $value['position'];?></b>
						    	<br>Slider Type : <?php echo $value['slidertype'];?>
						    	 
						    </td>
						    
						    <td class=" "><b></b>Heading : <?php echo $value['heading'];?>
						    	<br>Subheading : <?php echo $value['contentsmall'];?>
						    	 
						    </td>
						   
                          <td><img style="width: 100px;" src="../images/banner/<?php echo $value['image1'] ;?>"></td>
				 
						  
						 <td class="menu-action rounded-btn"> 
						 
						 <a href="editnewbanner.php?id=<?php echo $value['id'];?>" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> Edit  </a>
