...
$field =array('id','points','mobile_no');
...
$field_value=array($id,$points,$mobile_no);
$field =array('id','points','mobile_no');
      ...
      <div data-action="fullscreen" data-original-title="Remove Navigation Bar and Top Menu Toggle" data-toggle="tooltip" data-placement="bottom" class="fullscreen-button menu"> <i class="glyphicon glyphicon-fullscreen"></i> </div>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              ...
              <small class="subtitle">Grocery Dashboard</small>
              ...
              <div class="col-md-12">
                ...
                <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                         <input class="width-70" type="text" value="<?php echo $value[1];?>" data-toggle="tooltip" data-placement="top" name="points" required>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" value="<?php echo $value[2];?>" data-toggle="tooltip" data-placement="top" name="mobile_no" required>
                        </div>
                      </div>
