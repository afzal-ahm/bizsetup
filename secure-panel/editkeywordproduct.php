<?php
error_reporting(0);include_once 'config.php';
include_once'dbMysql.php';
$con = new DB_con();
$table="product";
$sku = $_GET['sku'];
$field = array('id','seo_title','seo_keyword','seo_metatag','seo_discription','product_name');
...
//$seo_metatag = $_POST['seo_metatag'];
//$product_des = $_POST['description'];
$seo_discription= $_POST['seo_discription'];
$seo_keyword = $_POST['seo_keyword'];    
	
$seo_title=	mysql_real_escape_string($seo_title);
//$seo_metatag=	mysql_real_escape_string($seo_metatag);
$seo_discription=	mysql_real_escape_string($seo_discription);
$seo_keyword=	mysql_real_escape_string($seo_keyword);
//$discount = $_POST['discount'];
$field_value=array($sku,$seo_title,$seo_discription,$seo_keyword);
$field = array('id','seo_title','seo_discription','seo_keyword');
...
window.location ='seoproductkeyword.php'
</script>
<?php
}
else{
    ...
    <div data-action="remove-navbar" data-original-title="Remove Navigation Bar Toggle" data-toggle="tooltip" data-placement="bottom" class="remove-navbar-button menu"> <i class="fa fa-arrows-h"></i> </div>
      ...
      <div data-action="fullscreen" data-original-title="Remove Navigation Bar and Top Menu Toggle" data-toggle="tooltip" data-placement="bottom" class="fullscreen-button menu"> <i class="glyphicon glyphicon-fullscreen"></i> </div>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Fosso Dashboard</h1>
              <small class="subtitle">Fosso Dashboard</small>
              ...
              <div class="col-md-12">
                ...
                <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" disabled="" value="<?php echo $value['product_name'] ?>" data-toggle="tooltip" data-placement="top" name="product_name" required>
                        </div>
                      </div>
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" value="<?php echo $value['seo_title'] ?>" data-toggle="tooltip" data-placement="top" name="seo_title" >
                        </div>
                      </div>
                     
                <!--      <div class="form-group">
                        <label class="col-sm-2 control-label">Seo metatag </label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input"  name="seo_metatag" value="<?php echo $value['seo_metatag'] ?>"  >
                        </div>
                      </div> -->
                          <div class="form-group">
                        <label class="col-sm-2 control-label">Seo keyword </label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text"  placeholder="Input"  name="seo_keyword" value="<?php echo $value['seo_keyword'] ?>"  >
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <textarea class=" "  id="" cols="70" name="seo_discription"  required rows="8"><?php echo $value['seo_discription'] ?> </textarea>
                        </div>
                      </div> 
