...
<div class="vd_body">
	...
	$query = "SELECT * from image_manager1 where id='".@$_GET['catid']."'";
...
<div class="form-group">
                    ...
                    <input type="file" name="image" class="form-control" required>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                         ...
                         <p><?php echo $dataval['subdervice'];  ?></p>
                        </div>
                      </div>
     ...
     <p><?php echo $dataval['section'];  ?></p>                   </div>
                      </div>
...
$image_name = $_FILES['image']['name'];
	...
	$query1 = "UPDATE image_manager1 SET image='$imagename' where id='".$_POST['edit_id']."'";
 ...
 echo'<script>location.assign("viewmedicalimage.php")</script>';
