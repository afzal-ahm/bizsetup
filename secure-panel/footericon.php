...
$image_name = $_FILES['image']['name'];
	 ...
	 $random_digit=rand(0000,9999);
	  ...
	  move_uploaded_file($image_tmp,"../images/client/$imagename");

$sel="INSERT into  fevicon (img) VALUES('$imagename')";
...
<script>
alert("Slider Added");
window.location ='viewfooter.php'
</script>
<?php
}
else{
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Footer Manager </h3>
                  </div>
