	...
	if(isset($_GET['del']))
{
	...
	$query = "delete from fevicon where id ='".$delete_id."'";
                                    ...
                                    <div class="panel widget">
                                        ...
                                        <div class="panel-body-list  table-responsive">
                                            <table class="table table-striped table-hover no-head-border">
                                                ...
                                                ?><tr>
                          <td><img src="../images/client/<?php echo $value['img'];?>" with="50px" height="50px"></td>
                          
							
						 <td class="menu-action rounded-btn"> <a href="viewfooter.php?del=<?php echo $value['id'];?>"   data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-times"></i> </a></td>
                       </tr>
