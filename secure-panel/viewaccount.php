                    ...
                    <div class="vd_content clearfix">
                        <div class="vd_title-section clearfix">
                            <div class="vd_panel-header">
                                <h1>Sub Account</h1>
                                <small class="subtitle">List of Sub Account</small> </div>
                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="panel widget">
                                        <div class="panel-heading vd_bg-grey">
                                            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> All Sub Account </h3>
                                        </div>
                                        <div class="panel-body-list  table-responsive">
                                            <table class="table table-striped table-hover no-head-border">
                                                ...
                                                <tbody>
                                                <?php
                                                foreach($res as $ke=>$value1){
                                                	$admin_account_name=$value1['admin_account_name'];
                                                	$admin_account_email=$value1['admin_account_email'];
                                                	$admin_account_password=$value1['admin_account_password'];$admin_account_image=$value1['admin_account_image'];
                                                    echo'<tr>
                          <td>'.$admin_account_name.'</td>
                           <td>'.$admin_account_email.'
                           <br> '.$admin_account_password.' <br> '.$admin_account_image.'</td>
							
						 <td class="menu-action rounded-btn">  <a href="viewaccount.php?deletecat='.$value1['id'].'""   data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-times"></i> </a></td>
                        </tr>';}?>
