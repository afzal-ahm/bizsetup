 ...
 if(isset($_POST['submit']))
{
	...
	// $query="INSERT into term_condition (content) VALUES ('$terms')";
	 ...
	 $query="UPDATE term_condition set policy_con='$terms' WHERE id=1 ";
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Add Privacy & Policy </h3>
                  </div>
