...
if(isset($_POST['btn-save']))
{
     ...
     $gggg="SELECT * from states where id='$state'";
$res=mysqli_query($conn,$gggg); 
 foreach($res as $ke=>$value)
 
     
     $sels="INSERT into medical (state,p_id,price,s_id) VALUES( '".$value['name']."','".$new."','".$title."','".$value['id']."')";
     $me=mysqli_query($conn,$sels);
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Add Price</h3>
                  </div>
                   ...
                   <div class="form-group">
                        <label class="col-sm-2 control-label">State</label>
                         <div class="col-sm-7 controls">
                          <select name="state">
                             <?php $gggg="SELECT * from states where country_id='101'";
$res=mysqli_query($conn,$gggg); 
 foreach($res as $ke=>$value){
?>
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Price</label>
                         <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" required data-placement="top" name="title" >
                         </div>
                      </div>
