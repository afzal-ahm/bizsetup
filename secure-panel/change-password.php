...
<div class="vd_body">
	...
	$query = "SELECT * from admin_account where id='2'";
	...
	$run = mysqli_query($conn, $query);
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          ...
                          <input class="width-70" type="text" placeholder="Input" value="<?php echo $dataval['admin_account_email'];  ?>" data-toggle="tooltip" data-placement="top" name="email" >
                        </div>
                      </div> <div class="form-group">
                        <label class="col-sm-2 control-label">Password</label>
                        <div class="col-sm-7 controls">
                         
                          <input class="width-70" type="text" placeholder="Input" value="<?php echo $dataval['admin_account_password'];  ?>" data-toggle="tooltip" data-placement="top" name="password" >
                        </div>
                      </div>
...
$content = $_POST['password'];
	...
	$query1 = "UPDATE admin_account SET admin_account_email='$title', admin_account_password='$content' where id='2'";

	$me=mysqli_query($conn,$query1);
	 $_SESSION['email']=$title;


 echo'<script>location.assign("change-password.php")</script>';
