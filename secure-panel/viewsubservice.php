...
if(isset($_GET['del'])){
	...
	$delete_id = $_GET['del'];
	 ...
	 $query = "delete from sub_service where id ='".$delete_id."'";
...
window.location ='viewsubservice.php'
</script>
<?php
}
else{
                ...
                <div class="vd_container">
                    <div class="vd_content clearfix">
                        ...
                        <div class="vd_content-section clearfix">
                                ...
                                <div class="col-md-12">
                                    <div class="panel widget">
                                        <div class="panel-heading vd_bg-grey">
                                            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> Sub Service </h3>
                                        </div>
						 ...
						 <td class="menu-action rounded-btn"><a href="subedit.php?catid='.$value['id'].'" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a> <a href="viewsubservice.php?del='.$value['id'].'""   data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-times"></i> </a></td>
                        </tr>';}?>
