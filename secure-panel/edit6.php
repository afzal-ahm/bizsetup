 ...
 if(isset($_POST['submit']))
{
	...
	if($image_name!=''){
	 ...
	 $image_tmp = $_FILES['image']['tmp_name'];    
	   ...
	   move_uploaded_file($image_tmp, "../images/blog/$imagename");
	   
	
	 $query="UPDATE testimonial set image='$imagename'  where id='".$_POST['edit_id']."'"; 
   ...
   $position = mysqli_real_escape_string($conn,$position);
	 $query="UPDATE testimonial set name='$name',content='$content',position='$position' where id='".$_POST['edit_id']."'";
...
window.location ='showtestimonial.php'
</script>
<?php
}
else{
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Add Testimonial </h3>
                  </div>
...
$query="SELECT * FROM testimonial where id='".@$_GET['edit']."'";
...
?>
                   ...
                   <form class="form-horizontal" action="#" method="post" name="form" role="form" enctype="multipart/form-data">
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input" value="<?php echo $name; ?>" data-toggle="tooltip" data-placement="top" name="name" > <input type="hidden" class="form-control" placeholder="" name="edit_id" value="<?php echo $_GET['edit']; ?>">
                        </div>
                      </div>
                  ...
                  <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <img src="../images/blog/<?php echo $row['image']; ?>" height="60" width="60">
                        </div>
                      ...
                      <div class="form-group">
                         ...
                         <div class="form-group">
                        <label class="col-sm-2 control-label">Edit Content</label>
                        <div class="col-sm-7 controls"> 
                           <textarea  class=" "  name="content" ><?php echo $content; ?></textarea>
                        </div>
                      </div>
    ...
    <div class="vd_bottom ">
        <div class="container">
            <div class="row">
              <div class=" col-xs-12">
                <div class="copyright">
                  	Copyright &copy;2016 admin Inc. All Rights Reserved 
                </div>
              </div>
            </div><!-- row -->
        </div><!-- container -->
