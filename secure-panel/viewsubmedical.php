...
if(isset($_GET['del'])){
	...
	$query = "delete from submedical where id ='".$delete_id."'";
                ...
                <div class="vd_container">
                    <div class="vd_content clearfix">
                        ...
                        <div class="vd_content-section clearfix">
						 ...
						 <td class="menu-action rounded-btn"><a href="submediedit.php?catid='.$value['id'].'" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a> <a href="viewsubmedical.php?del='.$value['id'].'""   data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-times"></i> </a></td>
                        </tr>';}?>
