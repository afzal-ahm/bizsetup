              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> view  Inventory Panel
                     <form method="post" style="float: right;" >
                    	<div class="col-md-12">
                    	<div class="col-md-6"> 
                    	</div>
                    	<div class="col-md-6">  <a href="database1.php" class="btn btn-danger btn-rounded man">BACKUP</a>  
                    	 </div>
                    	 </div>
                    </form>
                    <?php
...
foreach($images as $image)
{
 ...
 <tr>
		...
		<td><a href="<?php echo $image;?>"  class="btn btn-dander btn-xs"  target="_blank"> download </a></td>
			<td><a href="restore-bakup.php?file=<?php echo $image;?>"  class="btn btn-dander btn-xs"  target="_blank"> Restore </a></td>
