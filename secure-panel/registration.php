              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> view Appointments</h3>
                  </div>
...
?>               	
                      ...
                      <td> <span ><button class="<?php if(($row['status'])=='0') {echo 'label label-danger'; } else{ echo 'label label-success';};?>" onclick="return confirm('Are you sure?')"><?php if(($row['status'])=='0')
{
?>
