                                ...
                                <div class="col-md-12">
                                    <div class="panel widget">
                                        <div class="panel-heading vd_bg-grey">
                                            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> Content for change </h3>
                                        </div>
...
?>
                          ...
                          <td class="center"><?php echo $row['fast_free']; ?></td>
                           <td class="center"><?php echo $row['safe_secure']; ?></td>
                          <td class="center"><?php echo $row['get_order']; ?></td>
                           <td class="center"><?php echo $row['money_back']; ?></td>
                       
  <td class="center"><a href="content_edit.php"class=" btn btn-success btn-rounded">Edit</a></td>
