              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> view UnPaid Record</h3>
                  </div>
                  <div class="panel-body table-responsive">
                    <table class="table table-striped" id="data-tables">
                      ...
                      <tbody>
                        <?php 
                           $i=1;
 $query="SELECT * from payment where status='unpaid' order by id DESC";
...
?>               	
                        <tr class="odd gradeX">
                         ...
                         <td><span style="color:red"> Invoice No : <?php echo $row['invoice_no']; ?></span>
                         <br>name :<?php echo $row['user_name']; ?>
                         <br>Email :<?php echo $row['user_email']; ?>
                         	<br> Phone : <?php echo $row['user_phone']; ?>
                         	<br>State : <?php echo $row['state_name']; ?>
                         </td>
                         
                          <td>service : <?php echo $row['service']; ?>/ <?php echo $row['amount']; ?>
                            <br>GST Amount <?php echo $row['gstamount']; ?>
                          
                         </td>
                           <td>
                           <?php  $queryd="SELECT * from purchase_service where purchase_id='".$row['session_id']."'  ";
 $rund = mysqli_query($conn,$queryd);
 foreach($rund as $key=>$doc)
 {
 	?>
                           Service : <?php echo $doc['service_name']; ?>/ <?php echo $doc['service_cost']; ?>
                            <br> 
                         	<?php } ?> 
                          </td>
