...
$i=1;                         
$query="SELECT * FROM  newheadlines";
...
?>
                          ...
                          <td class="center"><img src="../images/top service/<?php echo $image; ?>" width="50" height="50" ></td>
                          <td class="center"><?php echo $content; ?></td>
  <td class="center"><a href="edit8.php?edit=<?php echo $id; ?> "class=" btn btn-success btn-rounded">Edit</a></td>
