...
$table = "product";$ac='';
$field_value=array($category_name1,$subcategory_name,$sub_subcategory_name,$status,$category_name,$sub_name,$sub_sub_name,$codep);
$field =array('product_category','product_subcategory','sub_subcategory_id','status','category','subcategory','subsubcategory','sku');
$res = $con->insert($field_value,$table,$field);
  if($res)
  {
  	$zz='asd';
  	$ds='<meta http-equiv="Refresh" content="2;url=add-product-vitual.php?sku='.$codep.'">' ;
                  ...
                  <div class="panel-body">
                    <form class="form-horizontal" action="" method="post" role="form">
                      <div id="wizard-2" class="form-wizard">
                        ...
                        <div class="tab-content no-bd pd-25" style="padding-top: 0px !important;padding-bottom: 0px !important;">
