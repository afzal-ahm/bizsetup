...
foreach($imge1 as $key=> $image1)
                        ...
                        <tr>
                          ...
                          <td class=" "><b></b> Title : <?php echo $value['seo_title'];?>
                          <br>Keyword :  <?php echo $value['seo_keyword'];?>
                       <!--   <br>Metatag : <?php echo $value['seo_metatag'];?> -->
                          <br> Discription  : <?php echo $value['seo_discription'];?>
                             </td>
						 ...
						 <td class="menu-action rounded-btn"> 
						  ...
						  <a target="_blank" href="editkeywordproduct.php?sku=<?php echo $value['id'];?>" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a>  
    ...
    <div class="vd_bottom ">
        <div class="container">
            <div class="row">
              <div class=" col-xs-12">
                <div class="copyright">
                  	Copyright &copy;2019 Admin. All Rights Reserved 
                </div>
              </div>
            </div><!-- row -->
        </div><!-- container -->
