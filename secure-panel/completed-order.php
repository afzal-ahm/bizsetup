...
//$field = array('process_type','id','order_id','total_amount','mobile_no','email_id','order_date','payment_type','invoice_status','feed');
//$Orders=$con->selectcatprod($table,$field_value,$field);


 $query="SELECT * from order_summary where process_type='completed' order by id DESC";
                    ...
                    <table class="table table-striped" id="data-tables">
                      ...
                      <tbody>
                       ...
                       <?php
                          ...
                          <td>'.$ordersvalue['order_id'].'</td>
						  <td>'.$ordersvalue['total_amount'].'</td>
						  
						  <td>'.$ordersvalue['email_id'].'<br>'.$ordersvalue['mobile_no'].'</td>
						  <td>'.$ordersvalue['order_date'].'</td>
						  <td>'.$ordersvalue['payment_type'].'</td>
						  <td>'.$ordersvalue['process_type'].'</td>
						  <td>'.$ordersvalue['feed'].'</td>
						  <td>';
                                                        if($ordersvalue['invoice_status'] ==''){
                                                           echo'<a href="invoice.php?Orderid='.$ordersvalue['order_id'].'"><span class="label label-warning">Generate Invoice</span></a></td>' ;
                                                        }else{
                                                            echo'<a href="viewinvoice.php?Orderid='.$ordersvalue['order_id'].'"><span class="label label-success">View Invoice</span></a></td>' ;
                                                        }
                                                        
echo ' <td><a href="status.php?id='.$ordersvalue['order_id'].'"><span class="label label-danger">Add status</span></a></td>';
						 echo'</tr>';}?>
