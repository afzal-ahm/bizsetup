...
if(isset($_GET['addtaxid'])){
    if(isset($_POST['btn-save']))
    {
        ...
        $vat = $_POST['vat'];
        $cst = $_POST['cst'];
        $state = $_POST['region_id'];
        $country = $_POST['country_id'];
        $today = date('Y-m-d');
        $field_value=array($vat,$country,$state,$today);
        $field=array('vat','country','state','date');
...
if(isset($_GET['deletetax'])){
    ...
    $deletetaxid = $_GET['deletetax']; 
      $delete_promo="DELETE FROM `tbl_tax` WHERE tax_id='".$deletetaxid."'";
    $runx=mysqli_query($conn,$delete_promo);
    if($runx)
    {
        ?>
        <script>
            alert("Taxid Successfully Deleted");
            window.location ='showtax.php'
        </script>
        <?php
    }
                    ...
                    <div class="vd_content clearfix">
                        <div class="vd_title-section clearfix">
                            <div class="vd_panel-header">
                                <h1>Tax Panel</h1>
                                <small class="subtitle">List of Txes</small> </div>
                        </div>
                        <div class="vd_content-section clearfix">
                                ...
                                <div class="col-md-12">
                                       ...
                                       echo'<form class="form-horizontal" action="" method="post" role="form">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7 controls">
                                                    <input class="width-70" type="number" value="'.$editdataval['vat'].'" data-toggle="tooltip" data-placement="top" name="vat">
                                                </div>
                                            </div>
                                          
                                            <input type="hidden" name="taxid" value="'.$editdataval['tax_id'].'">
                                    ...
                                    <div class="panel-body">
                                     ...
                                     <div class="panel widget">
                                        <div class="panel-heading vd_bg-grey">
                                            <h3 class="panel-title" style="float: left;"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> All Tax </h3>
                                            <h4 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span><a href="showtax.php?addtaxid"> ADD Tax</a></h4>
                                        </div>
						  ...
						  echo' 
						  <td>'.$taxesval['date'].'</td>
						 <td class="menu-action rounded-btn"><a href="showtax.php?edittaxid='.$taxesval['tax_id'].'" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a> <a href="showtax.php?deletetax='.$taxesval['tax_id'].'" data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-times"></i> </a></td>
                        </tr>';}
