...
<div class="form-group">
                  <label class="col-sm-2 control-label">walletamount  :</label>
                  <div class="col-sm-8">
                  <input class="width-70" type="number" placeholder="Input" data-toggle="tooltip" data-placement="top" value="<?php echo $dataval['walletamount']; ?>" name="walletamount">
                    
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">delivery_charge:</label>
                  <div class="col-sm-8">
                  <input class="width-70" type="number" placeholder="Input" data-toggle="tooltip" data-placement="top" value="<?php echo $dataval['delivery_charge']; ?>" name="delivery_charge">
                  </div>
                </div>
               <div class="form-group">
                  <label class="col-sm-2 control-label">Mimumum delivery amount:</label>
                  <div class="col-sm-8">
                  <input class="width-70" type="number" placeholder="Input" data-toggle="tooltip" data-placement="top" value="<?php echo $dataval['minimum']; ?>" name="minimum">
                  </div>
                </div>
...
//	   move_uploaded_file($image_tmp, "../images/$imagename");
	...
	$query1 = "UPDATE extra_amount SET delivery_charge='$delivery_charge' , walletamount='$walletamount',minimum='$minimum' where id='1'";
 ...
 echo "<script type=\"text/javascript\">".
        ...
        "</script>";
echo'<script>location.assign("extra-amount.php")</script>';}
?>  
