              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> view Enquiry</h3>
                  </div>
...
?>               	
            ...
            <div class="table-responsive">
               ...
               <td><input class="btn btn-danger btn-rounded man" name="delete" value="Delete Selected" type="submit" onclick="return confirm('Are you sure?')" /></td>
...
echo $sql = "DELETE FROM inquiry WHERE id='$del_id'";
