...
include("config.php");
	...
	$delete_id = $_GET['del'];
	if($delete_id!='') { 
	$query = "delete from logo where id ='".$delete_id."'";
                                    ...
                                    <div class="panel widget">
                                        ...
                                        <div class="panel-body-list  table-responsive">
                                            <table class="table table-striped table-hover no-head-border">
                                                ...
                                                <?php
                                                $gg="SELECT  * from logo ";
                                                $h=mysqli_query($conn,$gg);
                                                foreach($h as $ke=>$value){
                                                    echo'<tr>
                                                     <td>'.$value['heading'].' <br><img src="../images/'.$value['img'].'" width="50px" height="50px"></td>
                         
							
						 <td class="menu-action rounded-btn"><a href="editgallery.php?catid='.$value['id'].'" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a> <a href="gallery.php?del='.$value['id'].'""   data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-times"></i> </a></td>
                        </tr>';}?>
