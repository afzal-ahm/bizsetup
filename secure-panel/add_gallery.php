 ...
 if(isset($_POST['submit']))
{
	...
	$image_name = $_FILES['image']['name'];
	 ...
	 $image_tmp = $_FILES['image']['tmp_name'];    
   	...
   	$query="INSERT into logo(img,type,heading,link) VALUES('$imagename','$type','$heading','$link')";
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Add Image </h3>
                  </div>
                  <div class="panel-body">
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                            ...
                            <option value="move">Moving Content</option>
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
					  	...
					  	<div class="form-group">
                        <label class="col-sm-2 control-label">Add Heading only for (moving content)</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70"   type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" name="heading" >
                        </div>
                      </div>
					  
					  	<div class="form-group">
                        <label class="col-sm-2 control-label">Add Link only for (moving content)</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70"   type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" name="link" >
                        </div>
                      </div>
