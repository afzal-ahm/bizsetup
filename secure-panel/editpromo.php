...
if(isset($_GET['promoid'])){
    ...
    $field_value=array($Promoid);
    $field=array('promo_id','promo_title','promo_code','discount','datefrm','dateto');
    $data = $con->selectcatprod($table,$field_value,$field);
}
...
if(isset($_POST['btn-save']))
{
    ...
    $dateto = $_POST['dateto'];
    $today = date('Y-m-d');
    $field_value=array($promoid,$promoTitle,$promoCode,$discount,$datefrom,$dateto,$today);
    $field=array('promo_id','promo_title','promo_code','discount','datefrm','dateto','doi');
                            ...
                            <div class="col-md-12">
                                <div class="panel widget">
                                    <div class="panel-heading vd_bg-grey">
                                        <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Add Promocode </h3>
                                    </div>
                                    <div class="panel-body">
                                        <?php
                                        foreach($data as $key => $dataval)
                                        ?>
                                        <form class="form-horizontal" action="editpromo.php" method="post" role="form">
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Promo Title</label>
                                                <div class="col-sm-7 controls">
                                                    <input class="width-70" type="text" value="<?php echo $dataval['promo_title']; ?>" data-toggle="tooltip" data-placement="top" name="promotitle">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Promo Code </label>
                                                <div class="col-sm-7 controls">
                                                    <input class="width-70" type="text" value="<?php echo $dataval['promo_code']; ?>" data-toggle="tooltip" data-placement="top" name="promocode">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Discount </label>
                                                <div class="col-sm-7 controls">
                                                    <input class="width-70" type="number" value="<?php echo $dataval['discount']; ?>" data-toggle="tooltip" data-placement="top" name="discount">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Date From</label>
                                                <div class="col-sm-7 controls">
                                                    <input type="text" class="width-70" id="datetimepicker_dark" name="datefrom" data-rules-required="true" value="<?php echo $dataval['datefrm']; ?>" >
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Date To</label>
                                                <div class="col-sm-7 controls">
                                                    <input type="text" class="width-70" id="datetimepicker_darkto" name="dateto" data-rules-required="true" value="<?php echo $dataval['dateto']; ?>">
                                                </div>
                                            </div>
                                            <input type="hidden" name="promoid" value="<?php echo $_GET['promoid'] ;?>">
