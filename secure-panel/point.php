...
$field_value=array($point,$mobile_no);
$field=array('points','mobile_no');
$res = $con->insert($field_value,$table,$field);
if($res)
{
?>
<script>
alert("Points Inserted");
    ...
    <div data-action="remove-navbar" data-original-title="Remove Navigation Bar Toggle" data-toggle="tooltip" data-placement="bottom" class="remove-navbar-button menu"> <i class="fa fa-arrows-h"></i> </div>
      ...
      <div data-action="fullscreen" data-original-title="Remove Navigation Bar and Top Menu Toggle" data-toggle="tooltip" data-placement="bottom" class="fullscreen-button menu"> <i class="glyphicon glyphicon-fullscreen"></i> </div>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>MLM Dashboard</h1>
              <small class="subtitle">MLM Dashboard</small>
                  ...
                  <div class="panel-body">
                    <form class="form-horizontal" action="#" method="post" role="form">
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Add Points</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" name="points" required>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Mobile No</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" name="mobile_no" required>
                        </div>
                      </div>
