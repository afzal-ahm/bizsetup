					   ...
					   foreach($run as $ke=>$value){
                        ...
                        <tr>
                          ...
                          <td><?php echo $value['product_code'] ;?>   </td>
                             ...
                             <td><?php echo $value['name'] ;?><br><?php echo $value['email'] ;?> <br> <?php echo $value['date'] ;?>   </td>
						 ...
						 <a href="deleteproductcomment.php?sku=<?php echo $value['id'];?>"   data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-times"></i> </a>
