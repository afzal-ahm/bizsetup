...
$table = "admin_account";
 ...
 $name = $_POST['name']; $namex = 'sub';
     
	 
$field_value=array($name,$email,$password,$namex);
$field=array('admin_account_name','admin_account_email','admin_account_password','type');
...
$cms = $_POST['cms'];
$blog= $_POST['blog'];
$testimonail = $_POST['testimonail'];$faq = $_POST['faq'];
 


$table = "subadmin";
$field_value=array($product,$slider,$attribute,$inventory,$order,$promocode,$newslatter,$registration,$cms,$blog,$faq,$testimonail,$email);
$field=array('product','slider','attribute','inventory','order','promocode','newslatter','registration','cms','blog','faq','testimonail','email');
$res = $con->insert($field_value,$table,$field);
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Add Account </h3>
                  </div>
                    ...
                    <form class="form-horizontal" action="" method="post" role="form" enctype="multipart/form-data">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" name="name">
                        </div>
                      </div>
                        <div class="form-group">
                        <label class="col-sm-2 control-label">Add email</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" name="email">
                        </div>
                      </div>
					  
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Add Password</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="password" placeholder="Input" data-toggle="tooltip" data-placement="top" name="password">
                        </div>
                      </div>  
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                        <div class="radio">
                            <label><input type="radio" value="1" name="product">product Managment yes</label>
                        </div>
                       <div class="radio">
                          <label><input type="radio" value="0" name="product">product Managment no</label>
                       </div>
                       <br>
                       
                       <div class="radio">
                            <label><input type="radio" value="1" name="slider">slider Managment yes</label>
                        </div>
                       <div class="radio">
                          <label><input type="radio"value="0" name="slider">slider Managment no</label>
                       </div>
                       <br>
                       
                       
                       <div class="radio">
                            <label><input type="radio"value="1" name="attribute">attribute Managment yes</label>
                        </div>
                       <div class="radio">
                          <label><input type="radio"value="0" name="attribute">attribute Managment no</label>
                       </div>
                       <br>
                       
                       
                       <div class="radio">
                            <label><input type="radio"value="1" name="inventory">inventory Managment yes</label>
                        </div>
                       <div class="radio">
                          <label><input type="radio"value="0" name="inventory">inventory Managment no</label>
                       </div>
                       <br>
                       
                       
                       <div class="radio">
                            <label><input type="radio"value="1" name="order">order Managment yes</label>
                        </div>
                       <div class="radio">
                          <label><input type="radio"value="0" name="order">order Managment no</label>
                       </div>
                       <br>
                       
                       
                       <div class="radio">
                            <label><input type="radio"value="1" name="promocode">promocode Managment yes</label>
                        </div>
                       <div class="radio">
                          <label><input type="radio"value="0" name="promocode">promocode Managment no</label>
                       </div>
                       <br>
                       
                       
                       <div class="radio">
                            <label><input type="radio" value="1"name="newslatter">newslatter Managment yes</label>
                        </div>
                       <div class="radio">
                          <label><input type="radio"value="0" name="newslatter">newslatter Managment no</label>
                       </div>
                       <br>
                       
                       <div class="radio">
                            <label><input type="radio"value="1" name="registration">registration Managment yes</label>
                        </div>
                       <div class="radio">
                          <label><input type="radio" value="0"name="registration">registration Managment no</label>
                       </div>
                       <br>
                       <div class="radio">
                            <label><input type="radio"value="1" name="cms">cms Managment yes</label>
                        </div>
                       <div class="radio">
                          <label><input type="radio" value="0"name="cms">cms Managment no</label>
                       </div>
                       <br>
                       <div class="radio">
                            <label><input type="radio"value="1" name="blog">blog Managment yes</label>
                        </div>
                       <div class="radio">
                          <label><input type="radio"value="0" name="blog">blog Managment no</label>
                       </div>
                       <br>
                       
                       <div class="radio">
                            <label><input type="radio"value="1" name="faq">faq Managment yes</label>
                        </div>
                       <div class="radio">
                          <label><input type="radio" value="0"name="faq">faq Managment no</label>
                       </div>
                       <br>
                       
                       <div class="radio">
                            <label><input type="radio"value="1" name="testimonail">testimonail Managment yes</label>
                        </div>
                       <div class="radio">
                          <label><input type="radio"value="0" name="testimonail">testimonail Managment no</label>
                       </div>
                       <br>
