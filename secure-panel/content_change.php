...
<div class="vd_body">
                                ...
                                <div class="col-md-12">
                                    <div class="panel widget">
                                        <div class="panel-heading vd_bg-grey">
                                            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> After banner heading  </h3>
                                        </div>
                                        <div class="panel-body-list  table-responsive">
                                            <table class="table table-striped table-hover no-head-border">
                                                ...
                                                $query = "SELECT * from top_heading where id='2'";
	...
	$run = mysqli_query($conn, $query);
						 ...
						 <td class="menu-action rounded-btn"><a href="edit_content1.php?catid='.$value['id'].'" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a> </td>
                        </tr>';}?>
   ...
   <div class="vd_content-section clearfix">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="panel widget">
                                        <div class="panel-heading vd_bg-grey">
                                            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span>We Love Your Pets Content   </h3>
                                        </div>
                                        <div class="panel-body-list  table-responsive">
                                            <table class="table table-striped table-hover no-head-border">
                                                <thead class="vd_bg-green vd_white">
                                                ...
                                                <tbody>
                                                <?php
                                                $query = "SELECT * from top_heading LIMIT 4, 6";
	...
	$run = mysqli_query($conn, $query);
						 ...
						 <td class="menu-action rounded-btn"><a href="edit_content2.php?catid='.$value['id'].'" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a> </td>
                        </tr>';}?>
 ...
 <div class="vd_content-section clearfix">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="panel widget">
                                        <div class="panel-heading vd_bg-grey">
                                            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span>We Love Your Pets image   </h3>
                                        </div>
                                        <div class="panel-body-list  table-responsive">
                                            <table class="table table-striped table-hover no-head-border">
                                                <thead class="vd_bg-green vd_white">
                                                ...
                                                <tbody>
                                                <?php
                                                $query = "SELECT * from top_heading where id='12'";
                                             // SELECT * FROM Orders LIMIT 15, 10
	...
	$run = mysqli_query($conn, $query);
                          ...
                          <td><img src="../images/'.$value['img'].'" width="80px"></td>
                          
							
						 <td class="menu-action rounded-btn"><a href="edit_content4.php?catid='.$value['id'].'" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a> </td>
                        </tr>';}?>
 ...
 <div class="vd_content-section clearfix">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="panel widget">
                                        <div class="panel-heading vd_bg-grey">
                                            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i>  </span> After Slider Content </h3>
                                        </div>
                                        <div class="panel-body-list  table-responsive">
                                            <table class="table table-striped table-hover no-head-border">
                                                <thead class="vd_bg-green vd_white">
                                                ...
                                                <tbody>
                                                <?php
                                                $query = "SELECT * from top_heading LIMIT 1, 3";
                                             // SELECT * FROM Orders LIMIT 15, 10
	...
	$run = mysqli_query($conn, $query);
                          ...
                          <td>'.$value['heading'].'</td>
                          <td>'.$value['content'].'</td>
                          <td><img src="../images/'.$value['img'].'" width="50px"></td>
							
						 <td class="menu-action rounded-btn"><a href="edit_content3.php?catid='.$value['id'].'" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a> </td>
                        </tr>';}?>
                          ...
                          <div class="vd_content-section clearfix">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="panel widget">
                                        <div class="panel-heading vd_bg-grey">
                                            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> After Gallery Content  </h3>
                                        </div>
                                        <div class="panel-body-list  table-responsive">
                                            <table class="table table-striped table-hover no-head-border">
                                                <thead class="vd_bg-green vd_white">
                                                ...
                                                $query = "SELECT * from top_heading where id='13'";
