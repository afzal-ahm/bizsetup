...
include("config.php");
	...
	$query = "delete from  image_manager1 where id ='".$delete_id."'";
                    ...
                    <div class="vd_content clearfix">
                        <div class="vd_title-section clearfix">
                            <div class="vd_panel-header">
                                <h1>Medical image panel</h1>
                                <small class="subtitle">List of Categories</small> </div>
                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="panel widget">
                                        <div class="panel-heading vd_bg-grey">
                                            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> All Categories </h3>
                                        </div>
                                        <div class="panel-body-list  table-responsive">
                                            <table class="table table-striped table-hover no-head-border">
                                                ...
                                                foreach($res as $ke=>$value){
                                                    echo'<tr>
                                                     <td><img src="../images/service/'.$value['image'].'" width="50px" height="50px"></td>
                          <td>'.$value['service'].'</td>
                          <td>'.$value['subdervice'].'</td>
                          <td>'.$value['section'].'</td>
							
						 <td class="menu-action rounded-btn"><a href="editimage1.php?catid='.$value['id'].'" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a> <a href="viewmedicalimage.php?del='.$value['id'].'""   data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-times"></i> </a></td>
                        </tr>';}?>
