 ...
 if(isset($_POST['submit']))
{
	...
	//$query="INSERT into testimonial (name,content) VALUES ('$name','$content')";
	 ...
	 $query="UPDATE  top_heading set content='$content' where id='".$_POST['edit_id']."'";
...
$query="SELECT * FROM  top_heading where id='".@$_GET['edit']."'";
...
?>
                   ...
                   <form class="form-horizontal" action="#" method="post" name="form" role="form" enctype="multipart/form-data">
					...
					<div class="form-group">
                        <label class="col-sm-2 control-label">Update Heading</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input" value="<?php echo $content; ?>" data-toggle="tooltip" data-placement="top" name="content" > <input type="hidden" class="form-control" placeholder="" name="edit_id" value="<?php echo $_GET['edit']; ?>">
                        </div>
                      </div>
