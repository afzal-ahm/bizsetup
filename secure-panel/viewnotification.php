...
$status = 'new order';
 $Date = date('Y-m-d');
$field_value = array($status,$Date);
$field = array('process_type','order_date','order_id','total_amount','mobile_no','email_id','payment_type');
$Orders=$con->selecttwocond($table,$field_value,$field);
?>
                ...
                <div class="vd_container">
                    <div class="vd_content clearfix">
                        ...
                        <div class="vd_content-section clearfix">
						 ...
						 <td class="menu-action rounded-btn"><a href="singleorder.php?order_id='.$ordersvalue['order_id'].'" data-original-title="view" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-eye"></i> </a> <a href="" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a> <a href="#" data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-times"></i> </a></td>
                        </tr>';$i++;}?>
