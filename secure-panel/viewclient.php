...
$gggg="SELECT * from states where country_id='101'";
$res=mysqli_query($conn,$gggg);
	...
	if(isset($_GET['del']))
{
	...
	$query = "delete from states where id ='".$delete_id."'";
                    ...
                    <div class="vd_content clearfix">
                        <div class="vd_title-section clearfix">
                            <div class="vd_panel-header">
                                <h1>States</h1>
                                <small class="subtitle">List of States </small> </div>
                        </div>
                        <div class="vd_content-section clearfix">
                                ...
                                <div class="col-md-12">
                                    <div class="panel widget">
                                        <div class="panel-heading vd_bg-grey">
                                            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> All  States </h3>
                                        </div>
						 ...
						 <td class="menu-action rounded-btn">
						   <a href="viewclient.php?del=<?php echo $value['id'];?>"   data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-times"></i> </a>
						  <a href="state_edit.php?edit=<?php echo $value['id'];?>"   data-original-title="Edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-eye"></i> </a>
						 </td>
                       </tr>
