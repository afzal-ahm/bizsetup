   ...
   <?php include"adminleftmenu.php";?>  <div class="vd_navbar vd_nav-width vd_navbar-chat vd_bg-black-80 vd_navbar-right   ">
                    ...
                    <table class="table table-striped" id="data-tables">
                      ...
                      include "../include/config.php";
						...
						$date1=$_SESSION['date1'];
							 $query= "SELECT * from order_summary where order_date >='$date' AND order_date <= '$date1' ORDER by id DESC";
	$Orders = mysqli_query($conn,$query);
            ...
            <div class="row">
							...
							<div class="col-md-6">
							<td><td><button  onclick="return confirm('Are you sure?')"><a href="download5.php?date=<?php echo $date;?> && date1=<?php echo $date1;?>" class="deact btn btn-danger ">Download Search Record</a>
 </button></td></td>
						 </div>
