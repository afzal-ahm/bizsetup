...
$con = new DB_con();
$table = "tbl_promo";
$promos=$con->select($table);

if(isset($_GET['deletepromo'])){
    include_once"dbMysql.php";
$con = new DB_con();
$table = "tbl_promo";
$deletepromo = $_GET['deletepromo'];
    $field = array('promo_id');
    $field_value = array($deletepromo) ;
$delete_promo=$con->delete_user($table,$field,$field_value);
if($delete_promo)
{
    ?>
    <script>
        alert("PromoCode Successfully Deleted");
                    ...
                    <div class="vd_content clearfix">
                        <div class="vd_title-section clearfix">
                            <div class="vd_panel-header">
                                <h1>Promocode Panel</h1>
                                <small class="subtitle">List of Promocodes</small> </div>
                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="panel widget">
                                        <div class="panel-heading vd_bg-grey">
                                            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> All Promocodes </h3>
                                        </div>
                                        <div class="panel-body-list  table-responsive">
                                            <table class="table table-striped table-hover no-head-border">
                                                ...
                                                <tbody>
                                                <?php
                                                foreach($promos as $key=>$promosval){
                                                    echo'<tr>
                          <td>'.$promosval['promo_id'].'</td>
                          <td>'.$promosval['promo_title'].'</td>
						  <td>'.$promosval['promo_code'].'</td>
						  <td>'.$promosval['datefrm'].'</td>
						  <td>'.$promosval['dateto'].'</td>
						 <td class="menu-action rounded-btn"><a href="editpromo.php?promoid='.$promosval['promo_id'].'" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a> <a href="showpromo.php?deletepromo='.$promosval['promo_id'].'" data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-times"></i> </a></td>
                        </tr>';}?>
