...
elseif($_FILES['image']['name'] ==""){
	$query = "UPDATE term_condition SET about='$terms' where id='1'";
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Add About Us </h3>
                  </div>
                  <div class="panel-body">
                    <form class="form-horizontal" action="#" method="post" name="form" role="form" enctype="multipart/form-data">
					
					<div class="form-group">
                        <label class="col-sm-2 control-label">Add About us Images</label>
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label">About us Data</label>
                        <div class="col-sm-7 controls">
                         
                          <?php 
                         

$query = "SELECT * FROM term_condition WHERE id=1";
...
?>
 									...
 									<div class="form-group">
                                    	...
                                    	<textarea class="ckeditor" name="terms" id="" cols="70" rows="20">
                                    		<?php echo $content; ?>
                                    	</textarea>
                                    <?php } ?> 
                        </div>
