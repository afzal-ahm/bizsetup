                  ...
                  <div class="panel-body table-responsive">
                    <table class="table table-striped" id="data-tables">
                      ...
                      <tbody>
                        <?php 
                           $i=1;
  $query="SELECT * from logo1  order by id DESC";
...
?>               	
                      ...
                      <td><img src="../images/<?php echo $row['img']; ?>" width="50px"></td>
                      <td> 
                      <a href="edit_logo.php?id=<?php echo $row['id']; ?>"><span class="label label-success">edit</span></a></td>
					 ...
					 $query="DELETE FROM `logo1` WHERE `id`='$del'";
					   	$run=mysqli_query($conn,$query);
					   	
					   	 	echo'<script>alert("Deleted succesfully")</script>';
					   	
					   	echo'<script>location.assign("view_logo.php")</script>';
					 }
                     ?>
