...
$sel="INSERT into service_n (service_name,sub_sub_id,status) VALUES('$title','$sub','$new')";
...
echo "<script>window.open('add_service.php?new='.$newq.'','_self')</script>";
?>
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Add Features </h3>
                  </div>
                  <div class="panel-body">
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                           <input type="hidden" name="sub" value="<?php echo $_GET['new'];?>">
                           <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" required name="title" >
                        </div>
                      </div>
