          ...
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li class="active"> View Vaccination</li>
              </ul>
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> view Vaccination</h3>
                  </div>
                  <div class="panel-body table-responsive">
                    <table class="table table-striped" id="data-tables">
                      ...
                      <tbody>
                        ...
                        $cus_id = $_GET['id'];
                           $i=1;
 $query="SELECT * from vaccination where  user_id='$cus_id' order by id DESC ";
...
?>               	
                      ...
                      <td><img src="../vacination/vaction/<?php echo $row['batch_image']; ?>" width="50" height="50"></td>
                        <td><?php echo $row['v_date']; ?></td>
                         <td><img src="../vacination/vaction/<?php echo $row['signature']; ?>" width="50" height="50"></td>
                       
                        <td><?php echo $row['next_date']; ?></td>
                       <!--   <td><div class="vd_info"> <a href="editvacination.php?id=<?php echo $row['id']; ?>" class="btn vd_btn btn-xs vd_bg-yellow"> <i class="fa fa-pencil append-icon"></i> Edit  </a> </div></td>-->
            ...
            <div class="row">
							...
							<div class="col-md-6">
							<td><button class=" " onclick="return confirm('Are you sure?')"><a href="download1.php" class="deact btn btn-success " > Confirm appointment</a>
 </button></td>
						 </div>
						 <div class="col-md-6">
							<td><button  onclick="return confirm('Are you sure?')"><a href="download.php?" class="deact btn btn-danger "> Cancel appointment</a>
 </button></td>
						 </div>
                         </tr>
    ...
    <div class="vd_bottom ">
        <div class="container">
            <div class="row">
              <div class=" col-xs-12">
                <div class="copyright">
                  	Copyright &copy;2016 Godoggy.com. All Rights Reserved 
                </div>
              </div>
            </div><!-- row -->
        </div><!-- container -->
