...
<div class="vd_body">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="vd_content-wrapper">
                <div class="vd_container">
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <img src="../images/category/<?php echo $dataval['icon_image']; ?>" height="60" width="60">
                        </div>
                     ...
                     <div class="form-group">
                                                ...
                                                <div class="col-sm-7 controls">
                                                    <input class="width-70" type="text" value="<?php echo $dataval['duration']; ?>" data-toggle="tooltip" data-placement="top" name="duration">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7 controls">
                                                    <input class="width-70" type="text" value="<?php echo $dataval['startfrom']; ?>" data-toggle="tooltip" data-placement="top" name="startfrom">
                                                </div>
                                            </div>
                       <div class="form-group">
         ...
         <textarea class="ckeditor"  id="" cols="70" name="long_content"  required rows="20"><?php echo $dataval['long_content']; ?></textarea>
                        </div>
                      </div>  
