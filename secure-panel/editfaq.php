...
if(isset($_GET['catid'])){
    $catid = $_GET['catid'];
$table = "faq";
    $field_value=array($catid);
    $field=array('id','question','answer');
...
if(isset($_POST['btn-save']))
{
  ...
  //  $question = $_POST['question'];
   ...
   $table = "faq";
    $catid = $_POST['catid'];
    $question = $_POST['category_name'];
    $answer = $_POST['category_content'];
    
   $catid = $_GET['sid'];

		 $field_value=array($catid,$question,$answer);
        $field =array('id','question','answer');
 ...
 echo'<script>location.assign("viewfaq.php?new='.$catid.'")</script>';
        }
        else{
            ?>
 ...
 echo'<script>location.assign("viewfaq.php?new=?new='.$catid.'")</script>';
        }
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" action="" method="post" role="form" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">FAQ Question</label>
                                                <div class="col-sm-7 controls">
                                                    <input class="width-70" type="text" value="<?php echo $dataval['question']; ?>" data-toggle="tooltip" data-placement="top" name="category_name">
...
<div class="form-group">
                                                ...
                                                <div class="col-sm-7 controls">
                                                    <input class="width-70" type="text" value="<?php echo $dataval['answer']; ?>" data-toggle="tooltip" data-placement="top" name="category_content">
