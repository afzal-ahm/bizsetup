...
$table = "order_summary";
$status = 'new order';
$field_value = array($status);
$field = array('process_type','id','order_id','total_amount','mobile_no','email_id','order_date','payment_type');
$Orders=$con->selectcatprodlimit($table,$field_value,$field);
                                ...
                                <div class="col-md-12">
                                    <div class="panel widget">
                                        <div class="panel-heading vd_bg-grey">
                                            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span>Search/Download Records </h3>
                                        </div>
                                        <div class="panel-body-list  table-responsive">
                                            <table class="table table-striped table-hover no-head-border">
                                                ...
                                                <tbody>
                                               <form action="viewordersearch.php" method="post" enctype="multipart/form-data" >
                                                <tr>
                         
							<div class="col-md-4">
							<td> <b>From :</b></td><td> <input name="date" type="date" ></td>
						 </div>
						 <div class="col-md-4">
							<td> <b>To :</b></td><td> <input name="date1" type="date" ></td>
						 </div>
						 <div class="col-md-4">
							<td><button  name="search" class="deact btn btn-success " type="submit" name="search">Search
 </button></td>
						 </div>
          ...
          <div class="vd_content-section clearfix">
            <div class="row">
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> view orders</h3>
                  </div>
                  <div class="panel-body table-responsive">
                    <table class="table table-striped" id="data-tables">
                      ...
                      <tbody>
                        <?php 
                           $i=1;
  foreach($Orders as $ke=>$ordersvalue){
?>               	
                        <tr class="odd gradeX">
                         <td><?php echo $i++; ?></td>
                            <td><?php echo $ordersvalue['id'];?></td>
                          <td><a href="singleorder.php?order_id=<?php echo $ordersvalue['order_id'];?>"><?php echo $ordersvalue['order_id'];?></a></td>
						  <td><?php echo $ordersvalue['total_amount'];?></td>
						  <td><?php echo $ordersvalue['mobile_no'];?></td>
						  <td><?php echo $ordersvalue['email_id'];?></td>
						  <td><?php echo $ordersvalue['order_date'];?></td>
                     <td class="menu-action rounded-btn"><a href="singleorder.php?order_id=<?php echo $ordersvalue['order_id'];?>" data-original-title="view" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-eye"></i> </a> </td>
            ...
            <div class="row">
							...
							<div class="col-md-6">
							<td><button class=" " onclick="return confirm('Are you sure?')"><a href="download4.php" class="deact btn btn-success " > Download Records</a>
 </button></td>
						 </div>
