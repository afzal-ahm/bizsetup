...
$new = $_GET['new'];
	...
	$query = "delete from medical where id ='".$delete_id."'";
...
echo "<script>window.open('viewmedical.php?new='.$new.'','_self')</script>";
?>
...
<div class="vd_body">
                    ...
                    <div class="vd_content clearfix">
                        <div class="vd_title-section clearfix">
                            <div class="vd_panel-header">
                                ...
                                <small class="subtitle">List of  </small> </div>
                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="panel widget">
                                        <div class="panel-heading vd_bg-grey">
                                            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> All Price </h3>
                                        </div>
                                        <div class="panel-body-list  table-responsive">
                                            <table class="table table-striped table-hover no-head-border">
                                                ...
                                                <tbody>
                                                <?php
                                                   $query="SELECT * from medical where p_id='".$_GET['new']."'";
	...
	$run = mysqli_query($conn,$query);
						 ...
						 <td class="menu-action rounded-btn"><a href="editmedical.php?catid='.$value['id'].'&new='.$_GET['new'].'" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a> <a href="viewmedical.php?del='.$value['id'].'&new='.$_GET['new'].'"    data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-times"></i> </a></td>
                        </tr>';}?>
        ...
        <div class="vd_bottom ">
            <div class="container">
                <div class="row">
                    <div class=" col-xs-12">
                        <div class="copyright">
                            Copyright &copy;   Inc. All Rights Reserved
                        </div>
                    </div>
                </div><!-- row -->
            </div><!-- container -->
