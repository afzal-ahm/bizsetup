...
$table = "category";
 ...
 if($image_name1!='')
 {
	 ...
	 $random_digit1=rand(0000,9999);
	  ...
	  $ff="INSERT INTO `category`(  `category_name`, `content`, `design`, `image`, `url`, `type`, `banner`, `heading2`, `seo_title`, `seo_keywords`, `meta_description`, `created_at`, `updated_at`, `position`, `is_active`, `show_in_header`, `show_in_footer`) 
	  VALUES ('".$category_name."','".$design."','','".$imagename."','".$hyphenTag1."','".$type."','".$imagename1."' ,'".$heading2."','".$seo_title."','".$seo_keywords."','".$meta_description."','".$created_at."','".$updated_at."','0','0','0','0' )";
                  ...
                  <div class="panel-body">
                    <form class="form-horizontal" action="#" method="post" role="form" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Add Category name</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" name="category_name">
                        </div>
                      </div>
                      
                       <div class="form-group">
                        <label class="col-sm-2 control-label">Add Heading 2</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" name="heading2">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="SEO friendly title for search engines" data-toggle="tooltip" data-placement="top" name="seo_title" maxlength="60" id="seo_title">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <textarea class="width-70" rows="3" placeholder="Brief description for search engine results" name="meta_description" maxlength="160" id="meta_description"></textarea>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="keyword1, keyword2, keyword3" data-toggle="tooltip" data-placement="top" name="seo_keywords">
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Add Category Image</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="file" placeholder="Input" data-toggle="tooltip" data-placement="top" name="image" accept="image/*">
                          <small class="help-block">Upload category thumbnail image</small>
                        </div>
                      </div>  
                      
                       <div class="form-group">
                        <label class="col-sm-2 control-label">Add Banner Image</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="file" placeholder="Input" data-toggle="tooltip" data-placement="top" name="image1" accept="image/*">
                          <small class="help-block">Upload category banner image</small>
                        </div>
                      </div>  
                   ...
                   <div class="form-group">
                        <label class="col-sm-2 control-label">Add Category Content</label>
                        <div class="col-sm-7 controls">
                          
                          <textarea class="ckeditor"  id="" cols="70" name="category_content"  required rows="20">
