...
if(isset($_GET['sku']))
{
	$DD="DELETE FROM `keyword` WHERE id='".$_GET['sku']."'";
	$r=mysqli_query($conn,$DD);
	if($r)
	{
		

 echo'<script>location.assign("viewkeyword.php")</script>';
	}
}
?>
          ...
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li class="active"> View keyword</li>
              </ul>
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> view  keyword</h3>
                  </div>
	...
	$run = mysqli_query($conn,$query);
					   foreach($run as $ke=>$value){
                        ...
                        <tr>
                            ...
                            <td class=" " style="color:red;"><b></b> keyword : <?php echo $value['keyword'];?></td>
                          
						    <td class=" "><b></b> <?php echo $value['category_name'];?>
						 ...
						 <a href="editkeyword.php?sku=<?php echo $value['id'];?>" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a>
						  <a href="viewkeyword.php?sku=<?php echo $value['id'];?>" data-original-title="Delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a> 
