                ...
                <div class="vd_container">
                    <div class="vd_content clearfix">
                        ...
                        <div class="vd_title-section clearfix">
                            <div class="vd_panel-header">
                                <h1>Edit Content</h1>
                                <small class="subtitle">Edit Image</small>
                            ...
                            <div class="col-md-12">
                                <div class="panel widget">
                                    <div class="panel-heading vd_bg-grey">
                                        <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Edit Image </h3>
                                    </div>
...
<div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                 <input type="text" name="heading" value="<?php echo $dataval['heading']; ?>">
                  </div>
                </div>
<div class="form-group">
                  <label class="col-sm-2 control-label">Content  :</label>
                  <div class="col-sm-8">
                    <textarea class="ckeditor" name="content" ><?php echo $dataval['content']; ?></textarea>
                  </div>
                </div>
...
$image_name = $_FILES['image']['name'];
   ...
   $imagename = $random_digit.$image_name;
	...
	if($image_name !== ""){
 	...
 	$query1 = "UPDATE top_heading SET heading='$heading',content='$content',img='$imagename' where id='".$_POST['edit_id']."'";
		$me=mysqli_query($conn,$query1);
	}
	
else
{
	$query1 = "UPDATE top_heading SET heading='$heading',content='$content' where id='".$_POST['edit_id']."'";
		$me=mysqli_query($conn,$query1);
}
