...
<div class="content">
                    ...
                    <form class="form-horizontal" action="" enctype="multipart/form-data" method="post" role="form">
                      <div id="wizard-2" class="form-wizard">
                        ...
                        <li><a href="#tab21" data-toggle="tab">  <div class="menu-icon"> 1 </div> Select Category </a></li>
                          ...
                          <li  class="active"><a href="#tab25" data-toggle="tab"> <div class="menu-icon"> 5 </div>  Images </a></li>
                        </ul>
  ...
  <div id="image_preview"></div>
                    ...
                    <div class="plan-header vd_bg-blue vd_white text-center vd_info-parent">
                      <h3 class=" mgbt-xs-0">Images List</h3>
                       
                       </div>
                    <div class="features vd_bg-white font-sm content-list">
                      <ul class="list-wrapper">
                      <?php 
                        $select="SELECT * from   image_manager where p_sku='".$sku."'";
                      ...
                      ?>
                        <li><div class="col-md-6"> <img style="width: 70px;" src="../images/product/<?php echo $data['image'];?>"></div>  <div class="col-md-6"><a href="image-delete.php?sku=<?php echo $sku;?>&id=<?php echo $data['id'];?>">Delete</a></div>   </li>
                       <?php } ?>
                      </ul>
                      ...
                      <div class="col-md-12">
                       <div class="form-actions-condensed wizard">
                            <div class="row mgbt-xs-0">
                              <div class="col-sm-9  "><button class="btn vd_btn  "   style="background-color: #2A728D ;"  name="uploadimage" type="submit" >Upload Image <span class="menu-icon"><i class="fa fa-fw fa-chevron-circle-right"></i></span></button> 
                           
                           <a class="btn vd_btn pull-right " style="background-color: red;" href="complete-product.php?sku=<?php echo $_GET['sku'];?>"  >Next <span class="menu-icon"><i class="fa fa-fw fa-chevron-circle-right"></i></span></a>
                             </div>
                            </div>
                          </div>
                      </div>
