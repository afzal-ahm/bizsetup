...
$select="SELECT * from vendor_login where code='".$_GET['sku']."' ";
              ...
              <div class="col-sm-3">
                <div class="panel widget light-widget panel-bd-top">
                  ...
                  <div class="panel-body">
                    <div class="text-center vd_info-parent"> <img alt="example image" src="../images/profile/<?php echo $row['image'];?>"> </div>
                    <div class="row"> 
                    </div>
                    <h2 class="font-semibold mgbt-xs-5"><?php echo $row['username'];?></h2>
                   
                    <div class="mgtp-20">
                      <table class="table table-striped table-hover">
                        <tbody>
                          <tr>
                            <td style="width:60%;">Store</td>
                            <td><span class=" " onclick="return confirm('Are you sure?')">
				<?php if(($row['store'])=='0'){?>
        <a href="store.php?status=<?php echo $row['id'];?>" class="label label-danger " onclick="return confirm('Activate <?php echo $data?>');">Store Deactive </a>
<?php  }
if($row['store']=='1'){?>
<a href="store.php?status=<?php echo $row['id'];?>" 
 class="label label-success " onclick="return confirm('De-activate <?php echo $data?>');"> Store Active</a>
<?php  } ?> </span></td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td><span class=" " onclick="return confirm('Are you sure?')">
				<?php if(($row['status'])=='0'){?>
        <a href="actionaccount.php?status=<?php echo $row['id'];?>" class="label label-danger " onclick="return confirm('Activate <?php echo $data?>');">Account Deactive </a>
<?php  }
if($row['status']=='1'){?>
<a href="actionaccount.php?status=<?php echo $row['id'];?>" 
 class="label label-success " onclick="return confirm('De-activate <?php echo $data?>');"> Account Active</a>
<?php  } ?> </span></td>
                          </tr>
                          
                          <tr>
                            <td style="width:60%;">KYC</td>
                            <td><span class=" " onclick="return confirm('Are you sure?')">
				<?php if(($row['verified'])=='0'){?>
        <a href="kycactivate.php?status=<?php echo $row['id'];?>" class="label label-danger " onclick="return confirm('Activate <?php echo $data?>');">KYC Deactive </a>
<?php  }
if($row['verified']=='1'){?>
<a href="kycactivate.php?status=<?php echo $row['id'];?>" 
 class="label label-success " onclick="return confirm('De-activate <?php echo $data?>');"> KYC Active</a>
<?php  } ?> </span></td>
                          </tr>
  ...
  <ul class="nav nav-tabs widget">
    ...
    <li> <a data-toggle="tab" href="#projects-tab"> Documents <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>    
  </ul>
  <div class="tab-content">
    <div id="profile-tab" class="tab-pane active">
      <div class="pd-20">     
        <h3 class="mgbt-xs-15 mgtp-10 font-semibold"><i class="icon-user mgr-10 profile-icon"></i> ABOUT VENDOR</h3>
        <div class="row">
          <div class="col-sm-6">
          ...
          <div class="col-sm-6">
            <div class="row mgbt-xs-0">
              ...
              <div class="col-xs-7 controls"><?php echo $row['mobile'];?></div>
              <!-- col-sm-10 --> 
            </div>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-sm-6">
            <div class="row mgbt-xs-0">
              ...
              <div class="col-xs-7 controls"><?php echo $row['password_copy'];?></div>
              <!-- col-sm-10 --> 
            </div>
          </div>
          <div class="col-sm-6">
            <div class="row mgbt-xs-0">
              <label class="col-xs-5 control-label">registration_date:</label>
              <div class="col-xs-7 controls"><?php echo $row['registration_date'];?></div>
              <!-- col-sm-10 --> 
            </div>
          </div>
          <div class="col-sm-6">
            <div class="row mgbt-xs-0">
              ...
              <div class="col-xs-7 controls"><?php echo $row['pincode'];?></div>
              <!-- col-sm-10 --> 
            </div>
          </div>
          <div class="col-sm-6">
            <div class="row mgbt-xs-0">
              <label class="col-xs-5 control-label">brandname:</label>
              <div class="col-xs-7 controls"><?php echo $row['brandname'];?></div>
              <!-- col-sm-10 --> 
            </div>
          </div>
          <div class="col-sm-6">
            <div class="row mgbt-xs-0">
              ...
              <div class="col-xs-7 controls"><?php echo $row['address'];?></div>
              <!-- col-sm-10 --> 
            </div>
          </div>
    ...
    <div id="projects-tab" class="tab-pane">
    	<div class="pd-20">
				...
				<h3 class="mgbt-xs-15 mgtp-10 font-semibold"><i class="fa fa-bolt mgr-10 profile-icon"></i> Kyc </h3>     
				
			 <div class="row">	
				<div class="col-sm-6">
            <div class="row mgbt-xs-0">
              <label class="col-xs-5 control-label">account:</label>
              <div class="col-xs-7 controls"><?php echo $row['account'];?></div>
              <!-- col-sm-10 --> 
            </div>
          </div>
          <div class="col-sm-6">
            <div class="row mgbt-xs-0">
              ...
              <div class="col-xs-7 controls"><?php echo $row['bank'];?></div>
              <!-- col-sm-10 --> 
            </div>
          </div> <div class="col-sm-6">
            <div class="row mgbt-xs-0">
              <label class="col-xs-5 control-label">ifsc:</label>
              <div class="col-xs-7 controls"><?php echo $row['ifsc'];?></div>
              <!-- col-sm-10 --> 
            </div>
          </div><div class="col-sm-6">
            <div class="row mgbt-xs-0">
              <label class="col-xs-5 control-label">companyname:</label>
              <div class="col-xs-7 controls"><?php echo $row['companyname'];?></div>
              <!-- col-sm-10 --> 
            </div>
          </div><div class="col-sm-6">
            <div class="row mgbt-xs-0">
              <label class="col-xs-5 control-label">GST:</label>
              <div class="col-xs-7 controls"><?php echo $row['gst'];?></div>
              <!-- col-sm-10 --> 
            </div>
          </div>
		  </div>
