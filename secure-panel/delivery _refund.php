 ...
 if(isset($_POST['submit']))
{
	...
	// $query="INSERT into term_condition (content) VALUES ('$terms')";
	 ...
	 $query="UPDATE term_condition set delivery_return='$terms' WHERE id=1 ";
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Add Shipping & Refund </h3>
                  </div>
                  <div class="panel-body">
                    <form class="form-horizontal" action="#" method="post" name="form" role="form" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Add Data</label>
