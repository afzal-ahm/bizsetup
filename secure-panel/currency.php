...
if(isset($_POST['btn-save']))
{
    ...
    $euro = $_POST['euro'];
    $date = $_POST['date'];
    $field_value=array($us,$pound,$euro,$date);
    $field=array('us','pound','euro','date');
    ...
    if($res)
    {
        ...
        <script>
            ...
            window.location ='showcurrency.php'
        </script>
        <?php
    }
    else{
                                    ...
                                    <div class="panel-body">
                                        <form class="form-horizontal" action="#" method="post" role="form">
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Add US Doller  </label>
                                                <div class="col-sm-7 controls">
                                                    <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" name="us">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Add Pound </label>
                                                <div class="col-sm-7 controls">
                                                    <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" name="pound">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Add Euro </label>
                                                <div class="col-sm-7 controls">
                                                    <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" name="euro">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Date </label>
                                                <div class="col-sm-7 controls">
                                                    <input class="width-70" type="date" placeholder="Input" data-toggle="tooltip" data-placement="top" name="date">
                                                </div>
                                            </div>
