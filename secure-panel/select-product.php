    ...
    text-decoration: none;
        ...
        <div class="row el-element-overlay">
                    ...
                    foreach($run as $key=> $pro){
					       	 ...
					       	 $p_image="SELECT * from image_manager where p_sku='".$pro['sku']."' order by id ASC LIMIT 0,1";
	$result1=mysqli_query($conn,$p_image);
$ml=mysqli_fetch_array($result1);

	 $p_imagex="SELECT * from product  where sku='".$pro['sku']."'  ";
	$result1x=mysqli_query($conn,$p_imagex);
$mlx=mysqli_fetch_array($result1x);
                        ...
                        <div class="card" style="    height: 160px;">
                            <div class="el-card-item">
                                ...
                                <div class="el-card-content" style="padding: 28px;">
                                 <div class="row">
                                <div class="col-md-3"><img style="width: 100%; height: 82px;" src="../images/product/<?php echo $ml['image'];?>"></div>
                                 <div class="col-md-9">
                                    <h4 class="box-title" style="    font-size: 12px;"><a target="_blank" href="https://www.fosso.in/product-detail/<?php echo $mlx['url'];?>/<?php echo $mlx['sku'];?>"><?php echo $pro['product_name'];?></a></h4>
                                    <small style="border-top: 1px solid rgb(223, 223, 223);"><p>Brand <?php echo $pro['brand'];?>  </p></small>
                                  
                                      <small style="border-top: 1px solid rgb(223, 223, 223);"><p>SKU <?php echo $pro['sku'];?>  </p></small>
                                    
                                     <small style="border-top: 1px solid rgb(223, 223, 223); float: right;     text-align: right;
    width: 100%;">   <a   href="start-selling.php?c=<?php echo $pro['product_category'];?>&s=<?php echo $pro['product_subcategory'];?>&ss=<?php echo $pro['product_subcategory'];?>&b=<?php echo $pro['brand'];?>&sku=<?php echo $pro['sku'];?>" >START SELLING</a></small>
                                    </div> 
