                    ...
                    <table class="table table-striped" id="data-tables">
                     ...
                     <tbody>
                       <?php
                           ...
                           $i=1;
 $query="SELECT * from brands  where type='detail'  order by id DESC";
	...
	$run = mysqli_query($conn,$query);
					   foreach($run as $ke=>$value){
                        ...
                        <tr>
                           ...
                           <td><img style="width: 100px;" src="../images/brands/<?php echo $value['image'] ;?>"></td>
						 ...
						 <a href="editdetailoffer1.php?sku=<?php echo $value['id'];?>" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a> 
