          ...
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li class="active"> VIEW NEwslatter EMAIL </li>
              </ul>
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> VIEW NEwslatter</h3>
                  </div>
                  <div class="panel-body table-responsive">
                    <table class="table table-striped" id="data-tables">
                      ...
                      <tbody>
                        <?php
                           $i=1;
 $query="SELECT * from newsletter order by SubscriberID DESC";
...
?>
                       ...
                       if(isset($_GET['delid'])){
                       	...
                       	$del=$_GET['delid'];
					    	$query="DELETE FROM blog WHERE id='$del'";
					   	$run=mysqli_query($conn,$query);

					   	 	echo'<script>alert("Deleted succesfuly")</script>';

					   	echo'<script>location.assign("view_blog.php")</script>';
...
echo $select="select * from testimonial where id='$status1'";
...
$status_state=0;
 ...
 echo $update=mysqli_query($conn,"update testimonial set status='$status_state' where id='$status1' ");
if($update)
{
header("Location: testimonail.php");
}
else
{
echo mysqli_error();
 ...
 <div class="row">
              <div class="col-md-12">
                <div class="panel widget">
                  ...
                  <div class="col-md-3"> <a href="download.php"><button class="btn btn-danger">Male Record Download</button></a></div>
                   <div class="col-md-3"> <a href="download1.php"><button class="btn btn-sucess">Female Record Download</button></a></div>
                 </div>
                 </div>
                 </div> 
