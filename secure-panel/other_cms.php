...
<div class="form-group">
                  <label class="col-sm-2 control-label">Popup heading  :</label>
                  <div class="col-sm-8">
                  <input  type="text" name="heading1" value="<?php echo $dataval['heading1']; ?>">
                   
                  </div>
                </div>
                        
                    <div class="form-group">
                  <label class="col-sm-2 control-label">Popup Content :</label>
                  <div class="col-sm-8">
                  <input  type="text" name="heading2" value="<?php echo $dataval['heading2']; ?>">
                   
                  </div>
                </div>
                
                  <div class="form-group">
                  <label class="col-sm-2 control-label">Popup Price offere :</label>
                  <div class="col-sm-8">
                  <input  type="text" name="content2" value="<?php echo $dataval['content2']; ?>">
                   
                  </div>
                </div>  
                  <div class="form-group">
                  <label class="col-sm-2 control-label">Moving line top :</label>
                  <div class="col-sm-8">
                  <input  type="text" name="content3" value="<?php echo $dataval['content3']; ?>">
                                      ...
                                      <?php  if(isset($_POST['update']))
{
	...
	$content2=$_POST['content2'];  $content12=$_POST['content12'];  
	$content3=$_POST['content3'];  
	$number1=$_POST['number1'];  
	$number2=$_POST['number2'];  
	$number3=$_POST['number3'];  
	$number4=$_POST['number4'];  
	$numberc1=$_POST['numberc1'];  
	$numberc2=$_POST['numberc2'];  
	$numberc3=$_POST['numberc3'];  
	$numberc4=$_POST['numberc4'];  
	$f1=$_POST['f1']; $f2=$_POST['f2']; $f3=$_POST['f3'];  $tag=$_POST['tag'];    $tag1=$_POST['tag1'];   $t=$_POST['t'];   $td=$_POST['td'];  
	 $t1=$_POST['t1'];   $td1=$_POST['td1'];   $t1new=$_POST['t1new'];   $td1new=$_POST['td1new'];  
	 $query1 = "UPDATE `contact_info1` SET  `heading1`='".$heading1."',`heading2`='".$heading2."',`heading3`='".$heading3."',`content1`='".$content1."',`content2`='".$content2."',`content12`='".$content12."',`content3`='".$content3."' ,`number1`='".$number1."',`number2`='".$number2."',`number3`='".$number3."',`number4`='".$number4."',`numberc1`='".$numberc1."',`numberc2`='".$numberc2."',`numberc3`='".$numberc3."',`numberc4`='".$numberc4."',`f1`='".$f1."',`f2`='".$f2."',`f3`='".$f3."',`tag`='".$tag."' ,`tag1`='".$tag1."' ,`t`='".$t."' ,`td`='".$td."',`t1`='".$t1."' ,`td1`='".$td1."' ,`t1new`='".$t1new."' ,`td1new`='".$td1new."' where id='1'";
 ...
 echo "<script type=\"text/javascript\">".
        ...
        "</script>";
 echo'<script>location.assign("other_cms.php")</script>';
}
?>  
