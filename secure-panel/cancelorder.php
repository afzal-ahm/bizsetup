...
$field = array('process_type','id','order_id','total_amount','mobile_no','email_id','order_date','payment_type','remarks');
                ...
                <div class="vd_container">
                    <div class="vd_content clearfix">
                        ...
                        <div class="vd_content-section clearfix">
						  ...
						  <td>'.$ordersvalue['remarks'].'</td>
						   <td><span class="label label-danger">'.$ordersvalue['process_type'].'</span></td>
        ...
        <div class="vd_bottom ">
            <div class="container">
                <div class="row">
                    <div class=" col-xs-12">
                        <div class="copyright">
                            Copyright &copy;2015 MLM Inc. All Rights Reserved
                        </div>
                    </div>
                </div><!-- row -->
            </div><!-- container -->
