...
$offer_amount=round($offer_amount);
 ...
 if($product_offer=="")
 {
  ...
  $theme = 'no';
  $brand = $_POST['brand'];$strip = $_POST['strip'];
  $type = $_POST['type'];
  $gender = $_POST['gender'];
  $design = $_POST['design'];
  $stock = $_POST['stock'];
  $new_exclusive = $_POST['new_exclusive'];
   $sleeves = $_POST['sleeves'];
     $material = $_POST['material'];
      $product_des = $_POST['content']; $type3 = $_POST['type3'];
$table = "product";$ac='';
$field_value=array( $product_name,$product_des,$product_sku,$product_price,$status,$delivery,$brandactive, $offer_amount,$product_offer,$status,$hyphenTag1,$theme,$brand,$type3,$strip);
$field =array( 'product_name','description','sku','mrp','status','delivery','brandactive','offer_amount','offer','featured','url','theme','brand','demo2','demo1');
$res = $con->insert($field_value,$table,$field);
  if($res)
  {
  	

  echo'<script>location.assign("addproductnon.php")</script>';
	}  }
	?>
          ...
          <div class="row" id="advanced-input">
              <div class="col-md-12">
                <div class="panel widget">
                  ...
                  <div class="panel-body">
                    <form class="form-horizontal" enctype="multipart/form-data" action="" role="form" method="post">
                        ...
                        <label class="col-sm-2 control-label">Add Product Type</label>
                        <div class="col-sm-7 controls">
                          
                          <select name="type3" class="width-70"  >
                ...
                <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input"  name="product_name" required>
                        </div>
                      </div>
                       
                     
                       <div class="form-group">
                        <label class="col-sm-2 control-label">Add brand</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input"  name="brand" required>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input"  name="product_offer" required>
                        </div>
                      </div>
                      
                          <div class="form-group">
                        <label class="col-sm-2 control-label">Add Product price </label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input"  name="product_price" required>
                        </div>
                      </div> 
                      
                       <div class="form-group">
                        <label class="col-sm-2 control-label">Add Strip</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input"  name="strip" required>
                        </div>
                      </div>  
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Add Brand</label>
