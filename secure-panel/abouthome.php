...
if($image_type=="image/jpeg" or $image_type=="image/png" or $image_type=="img/gif"){
	if ($image_size<=5000000){
  	move_uploaded_file($image_tmp, "../images/abouth/$image_name");
	}
	else{
...
//$query="INSERT into  (img,content) VALUES ('$image_name','$terms')";
	 $query = "UPDATE logo SET content='$terms', img1='$image_name' ";
	 	 $me=mysqli_query($conn,$query);
	 	 }

elseif($_FILES['image']['name'] ==""){
	$query = "UPDATE logo SET content='$terms' ";
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Add About Us On Home Page </h3>
                  </div>
                  <div class="panel-body">
                    <form class="form-horizontal" action="#" method="post" name="form" role="form" enctype="multipart/form-data">
					
					<div class="form-group">
                        <label class="col-sm-2 control-label">Add Logo</label>
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Abous us (home page)</label>
                        <div class="col-sm-7 controls">
