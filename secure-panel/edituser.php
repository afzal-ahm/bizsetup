...
if(isset($_POST['btn-save']))
{
    ...
    $email = $_POST['email'];
    $city = $_POST['city'];
    $field = array('customer_user_id','fname','mobile_no','pincode','address','email','city');
    $field_value = array($cus_id,$c_name,$mobile_no,$pincode,$address,$email,$city);
...
<meta http-equiv="content-type" content="text/html;charset=UTF-8" />
    ...
    <div class="vd_panel-menu  hidden-xs">
        ...
        <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Add Customer Profile </h3>
    </div>
    ...
    <div class="col-sm-7 controls">
        <input class="width-70" type="text" value="<?php echo $value['fname'] ?>"  name="fname" required>
    </div>
    </div>
    ...
    <div class="col-sm-7 controls">
        <input class="width-70" type="text" value="<?php echo $value['mobile_no'] ?>"  name="mobile_no" required>
    </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label">E Mail : </label>
    <div class="col-sm-7 controls">
        <textarea name="email"  required><?php echo $value['email'] ?></textarea>
    </div>
    </div>
    ...
    <div class="col-sm-7 controls">
        <input class="width-70" type="text" value="<?php echo $value['address'] ?>"  name="address" required>
    </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label">City :  </label>
        <div class="col-sm-7 controls">
        <input class="width-70" type="text" value="<?php echo $value['city'] ?>"  name="city" required>
    </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label">Pin code : </label>
        <div class="col-sm-7 controls">
        <input class="width-70" type="text" value="<?php echo $value['pincode'] ?>" name="pincode" required>
    </div>
    </div>
