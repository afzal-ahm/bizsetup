...
<div class="vd_body">
    ...
    <div class="content">
                ...
                <div class="vd_container">
                    <div class="vd_content clearfix">
                        ...
                        <div class="vd_title-section clearfix">
                            <div class="vd_panel-header">
                                <h1>Admin Content</h1>
                                <small class="subtitle">Admin Content</small>
	 ...
	 $query = "SELECT * from extra_content where id='1'";
    ...
    <div class="form-group">
                  ...
                  <div class="col-sm-8">
                   <img src="../images/service/<?php echo $dataval['image1']; ?>"width="50px">
                  </div>
                </div>
 ...
 <div class="form-group">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">  image  :</label>
                  <div class="col-sm-8">
                   <img src="../images/service/<?php echo $dataval['image2']; ?>"width="50px">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">  image  :</label>
                  <div class="col-sm-8">
                   <img src="../images/service/<?php echo $dataval['image3']; ?>"width="50px">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                   <img src="../images/service/<?php echo $dataval['image4']; ?>"width="50px">
                  </div>
                </div>
  ...
  <div class="form-group">
                  ...
                  <div class="col-sm-8">
                   <img src="../images/service/<?php echo $dataval['image5']; ?>"width="50px">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">link5   :</label>
                  <div class="col-sm-8">
  ...
  <div class="form-group">
                  ...
                  <div class="col-sm-8">
                   <img src="../images/service/<?php echo $dataval['image6']; ?>"width="50px">
                  </div>
                </div>
               
                <div class="form-group">
                  <label class="col-sm-2 control-label">Imag6   :</label>
                  <div class="col-sm-8">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">lin6   :</label>
                  <div class="col-sm-8">
                    <input type="text" name="link6">
  ...
  <div class="form-group">
                  <label class="col-sm-2 control-label">  image7  :</label>
                  <div class="col-sm-8">
                   <img src="../images/service/<?php echo $dataval['image7']; ?>"width="50px">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">link7   :</label>
                  <div class="col-sm-8">
                    <input type="text" name="link7">
  ...
  <div class="form-group">
                  <label class="col-sm-2 control-label">  image8  :</label>
                  <div class="col-sm-8">
                   <img src="../images/service/<?php echo $dataval['image8']; ?>"width="50px">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">lin8   :</label>
                  <div class="col-sm-8">
  ...
  <div class="form-group">
                  <label class="col-sm-2 control-label">  image9  :</label>
                  <div class="col-sm-8">
                   <img src="../images/service/<?php echo $dataval['image9']; ?>"width="50px">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">link9   :</label>
                  <div class="col-sm-8">
                    <input type="text" name="link9">
  ...
  <div class="form-group">
                  <label class="col-sm-2 control-label">  image10  :</label>
                  <div class="col-sm-8">
                   <img src="../images/service/<?php echo $dataval['image10']; ?>"width="50px">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">link10   :</label>
                  <div class="col-sm-8">
                    <input type="text" name="link10">
  ...
  <div class="form-group">
                  <label class="col-sm-2 control-label">  image11  :</label>
                  <div class="col-sm-8">
                   <img src="../images/service/<?php echo $dataval['image11']; ?>"width="50px">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">link11   :</label>
                  <div class="col-sm-8">
                    <input type="text" name="link11">
  ...
  <div class="form-group">
                  <label class="col-sm-2 control-label">  image12  :</label>
                  <div class="col-sm-8">
                   <img src="../images/service/<?php echo $dataval['image12']; ?>"width="50px">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">link12   :</label>
                  <div class="col-sm-8">
                    <input type="text" name="link12">
  ...
  <div class="form-group">
                  <label class="col-sm-2 control-label">  image13  :</label>
                  <div class="col-sm-8">
                   <img src="../images/service/<?php echo $dataval['image13']; ?>"width="50px">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">link 13  :</label>
                  <div class="col-sm-8">
                    <input type="text" name="link13">
  ...
  <div class="form-group">
                  <label class="col-sm-2 control-label">  image14  :</label>
                  <div class="col-sm-8">
                   <img src="../images/service/<?php echo $dataval['image14']; ?>"width="50px">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">link14  :</label>
                  <div class="col-sm-8">
                    <input type="text" name="link14">
  ...
  <div class="form-group">
                  <label class="col-sm-2 control-label">  image15  :</label>
                  <div class="col-sm-8">
                   <img src="../images/service/<?php echo $dataval['image15']; ?>"width="50px">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">link15   :</label>
                  <div class="col-sm-8">
                    <input type="text" name="link15">
                                      ...
                                      <?php  if(isset($_POST['update']))
{
	 ...
	 $image_tmp1 = $_FILES['image1']['tmp_name'];    
	   ...
	   move_uploaded_file($image_tmp1, "../images/service/$imagename1");
	   $query1 = "UPDATE extra_content SET image1='$imagename1'   where id='1'";
	 ...
	 $image_tmp2 = $_FILES['image2']['tmp_name'];    
	   ...
	   $imagename2 = $random_digit2.$image_name2;
	   move_uploaded_file($image_tmp2, "../images/service/$imagename2");
	   $query1 = "UPDATE extra_content SET image2='$imagename2'   where id='1'";
       $me=mysqli_query($conn,$query1);
	  }
	 ...
	 $image_tmp3 = $_FILES['image3']['tmp_name'];    
       $random_digit3=rand(0000,9999);
	   $imagename3 = $random_digit3.$image_name3;
	   move_uploaded_file($image_tmp3, "../images/service/$imagename3");
	   $query1 = "UPDATE extra_content SET image3='$imagename3'   where id='1'";
       $me=mysqli_query($conn,$query1);
	  }
	 ...
	 $image_tmp4 = $_FILES['image4']['tmp_name'];    
       $random_digit4=rand(0000,9999);
	   $imagename4 = $random_digit4.$image_name4;
	   move_uploaded_file($image_tmp4, "../images/service/$imagename4");
	   $query1 = "UPDATE extra_content SET image4='$imagename4'   where id='1'";
       $me=mysqli_query($conn,$query1);
	  }
 ...
 echo "<script type=\"text/javascript\">".
        ...
        "</script>";
echo'<script>location.assign("about-advertise1.php")</script>';}
?>  
