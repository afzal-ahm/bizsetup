...
<div class="vd_body">
	...
	$query = "SELECT * from image_manager where id='".@$_GET['catid']."'";
...
$image_name = $_FILES['image']['name'];
	...
	$query1 = "UPDATE image_manager SET image='$imagename' where id='".$_POST['edit_id']."'";
 ...
 echo'<script>location.assign("viewimage.php")</script>';
