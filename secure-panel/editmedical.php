...
<div class="vd_body">
                            ...
                            <div class="col-md-12">
                                <div class="panel widget">
                                    <div class="panel-heading vd_bg-grey">
                                        <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Edit Document </h3>
                                    </div>
	...
	$query = "SELECT * from medical where id='".@$_GET['catid']."'";
	...
	$run = mysqli_query($conn, $query);
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          ...
                          <input class="width-70" type="text" placeholder="Input" value="<?php echo $dataval['price'];  ?>" data-toggle="tooltip" data-placement="top" name="title" >
                        </div>
                      </div>
...
$content = $_POST['content'];
	...
	$query1 = "UPDATE medical SET price='$title'  where id='".$_POST['edit_id']."'";
