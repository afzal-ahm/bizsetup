...
$table="product";
$sku = $_GET['sku'];
$field = array('sku','product_name','brand_name','description','quantity','unit_price','mrp','discount','image');
...
<div class="content">
              ...
              <div class="col-sm-3">
                <div class="panel widget light-widget panel-bd-top">
                  ...
                  <div class="panel-body">
                    <div class="text-center vd_info-parent"> <img alt="example image" src="productimages/'.$value['image'].'"> </div>

                    <h2 class="font-semibold mgbt-xs-5">'.$value['product_name'].'</h2>
  ...
  <ul class="nav nav-tabs widget">
    <li class="active"> <a data-toggle="tab" href="#profile-tab"> Products <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
 ...
 <div class="tab-content">
    <div id="profile-tab" class="tab-pane active">
      <div class="pd-20">
<div class="vd_info tr"> <a href="editproduct.php?sku='.$value['sku'].' " class="btn vd_btn btn-xs vd_bg-yellow"> <i class="fa fa-pencil append-icon"></i> Edit </a> </div>
        <h3 class="mgbt-xs-15 mgtp-10 font-semibold"><i class="icon-user mgr-10 profile-icon"></i>About Product</h3>
        <div class="row">
          
          <div class="col-sm-6">
            <div class="row mgbt-xs-0">
              <label class="col-xs-5 control-label">SKU Code:</label>
              <div class="col-xs-7 controls">'.$value['sku'].'</div>
              <!-- col-sm-10 --> 
            </div>
          </div>
          <div class="col-sm-6">
            <div class="row mgbt-xs-0">
              ...
              <div class="col-xs-7 controls">'.$value['product_name'].'</div>
              <!-- col-sm-10 --> 
            </div>
          </div>
          <div class="col-sm-6">
            <div class="row mgbt-xs-0">
              <label class="col-xs-5 control-label">Brand Name:</label>
              <div class="col-xs-7 controls">'.$value['brand_name'].'</div>
              <!-- col-sm-10 --> 
            </div>
          </div>
          <div class="col-sm-6">
            <div class="row mgbt-xs-0">
              ...
              <div class="col-xs-7 controls">'.$value['description'].'</div>
              <!-- col-sm-10 --> 
            </div>
          </div>
          <div class="col-sm-6">
            <div class="row mgbt-xs-0">
              <label class="col-xs-5 control-label">Quantity:</label>
              <div class="col-xs-7 controls">'.$value['quantity'].'</div>
              <!-- col-sm-10 --> 
            </div>
          </div>
          <div class="col-sm-6">
            <div class="row mgbt-xs-0">
              <label class="col-xs-5 control-label">Unit Price:</label>
              <div class="col-xs-7 controls">'.$value['unit_price'].'</div>
              <!-- col-sm-10 --> 
            </div>
          </div>
          <div class="col-sm-6">
            <div class="row mgbt-xs-0">
              ...
              <div class="col-xs-7 controls">'.$value['mrp'].'</div>
              <!-- col-sm-10 --> 
            </div>
          </div>
          ...
          <div class="col-sm-6">
            <div class="row mgbt-xs-0">
              ...
              <div class="col-xs-7 controls">'.$value['discount'].'</div>
              <!-- col-sm-10 --> 
            </div>
          </div>
