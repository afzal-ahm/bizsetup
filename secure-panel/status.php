              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Order status </h3>
                  </div>
                    ...
                    <form class="form-horizontal" enctype="multipart/form-data" action="" role="form" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <textarea class="width-70" type="text" placeholder="Input"  name="status" required></textarea>
                          <input type="hidden" name="sku" value="<?php echo $_GET['id'];?>" >
                        </div>
                      </div>
...
if(isset($_POST['btn-save']))
{
  ...
  $query="UPDATE order_summary SET feed='$status' where order_id='$sku'";
...
window.location ='completed-order.php'
</script>
<?php
}
else{
