...
if(isset($_POST['btn-save']))
{
    ...
    $today = date('Y-m-d');
  $in="INSERT INTO attributemanager (attributes,description,ondate,price) VALUES ('$attribute','$description','$today','$price') ";
   $res=mysqli_query($conn,$in);
    if($res)
    {
        ...
        <script>
            alert("This IS Already  Exists Please try another");
            window.location ='productattribute.php'
        </script>
        <?php
    }
}
                            ...
                            <div class="col-md-12">
                                <div class="panel widget">
                                    <div class="panel-heading vd_bg-grey">
                                        <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Add Attributes </h3>
                                    </div>
                                    <div class="panel-body">
                                        <form class="form-horizontal" action="" method="post" role="form">
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label"> Product attribute </label>
                                                <div class="col-sm-7 controls">
                                                   <select class="width-70 form-control" name="attributes">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Color/Size</label>
                                                <div class="col-sm-7 controls">
                                                    <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" name="description" required>
                                                </div>
                                            </div>
                                               <input class="width-70" type="hidden" placeholder="Input" data-toggle="tooltip" data-placement="top" name="price"  >
                                                 
                                          <!--  <div class="form-group">
                                                <label class="col-sm-2 control-label">Status </label>
                                                <div class="col-sm-7 controls">
                                                    <select class="width-70 form-control" name="status">
        ...
        <div class="vd_bottom ">
            <div class="container">
                <div class="row">
                    <div class=" col-xs-12">
                        <div class="copyright">
                            Copyright &copy;2018 AdminInc. All Rights Reserved
                        </div>
                    </div>
                </div><!-- row -->
            </div><!-- container -->
