 ...
 if(isset($_POST['submit']))
{
	 ...
	 $phone = $_POST['phone'];
	  $address = $_POST['address']; $address1 = $_POST['address1'];$address2 = $_POST['security'];
	   $email = $_POST['email'];
	  $email1 = $_POST['email1'];
	  $email2 = $_POST['email2'];
	    ...
	    //$query="INSERT into contact_info (address,phone,email,content) VALUES('".$address."','".$phone."','".$email."','".$terms."')";
	    
	
	$query="UPDATE contact_info SET address='".$address."',address1='".$address1."',security='".$address2."', phone='".$phone."',us='".$us."',uk='".$uk."', email='".$email."', email1='".$email1."', email2='".$email2."' where id='1'";
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Add Contact Us Data </h3>
                  </div>
                  <div class="panel-body">
                    <form class="form-horizontal" action="#" method="post" name="form" role="form" enctype="multipart/form-data">
					  <?php 
...
?>
					...
					<div class="form-group">
                        <label class="col-sm-2 control-label">Update Domestic Number</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" value="<?php echo $phone; ?>" data-toggle="tooltip" data-placement="top" name="phone" >
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Update Internation phone No </label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" value="<?php echo $us; ?>" data-toggle="tooltip" data-placement="top" name="us" >
                        </div>
                      </div>
                     <div class="form-group">
                        <label class="col-sm-2 control-label">Whatup phone No </label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" value="<?php echo $uk; ?>" data-toggle="tooltip" data-placement="top" name="uk" >
                        </div>
                      </div>
                     
                     <div class="form-group">
                         <label class="col-sm-2 control-label">Update  Email id  </label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" value="<?php echo $email; ?>" data-toggle="tooltip" data-placement="top" name="email" >
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Update address  Domestic </label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" value="<?php echo $address; ?>" data-toggle="tooltip" data-placement="top" name="address" >
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Update address  Internation </label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" value="<?php echo $address2; ?>" data-toggle="tooltip" data-placement="top" name="security" >
                        </div>
                      </div>
                    ...
                    <?php 
                       ...
                       <button class="btn vd_btn vd_bg-green vd_white" type="submit" name="submit"><i class="icon-ok"></i> Save</button>
                    </form>
                  </div>
                </div>
                <!-- Panel Widget --> 
