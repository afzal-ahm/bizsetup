...
<div class="content">
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> view Images</h3>
                  </div>
  ...
  $query="SELECT * from image_manager  order by id DESC";
	...
	while ($row=mysqli_fetch_array($run))
	{
		 ...
		 $query1="SELECT * from product where sku='".$resume."'   ";
...
?>               	
                      ...
                      <td><img src="../images/product/<?php echo $row['image']; ?>" width="50px"></td>
                      <td><a href="view_images.php?id=<?php echo $row['id']; ?>"><span class="label label-success">Delete</span></a></td>
					 ...
					 $query="DELETE FROM `image_manager` WHERE `id`='$del'";
					   	$run=mysqli_query($conn,$query);
					   	
					   	 	echo'<script>alert("Deleted succesfully")</script>';
					   	
					   	echo'<script>location.assign("view_images.php")</script>';
					 }
                     ?>
