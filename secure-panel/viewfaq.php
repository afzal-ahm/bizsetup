                    ...
                    <div class="vd_content clearfix">
                        <div class="vd_title-section clearfix">
                            <div class="vd_panel-header">
                                <h1>FAQ</h1>
                                <small class="subtitle">List of FAQ</small> </div>
                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="panel widget">
                                        <div class="panel-heading vd_bg-grey">
                                            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> All FAQ </h3>
                                        </div>
                                        <div class="panel-body-list  table-responsive">
                                            <table class="table table-striped table-hover no-head-border">
                                                ...
                                                $gg="SELECT * from faq where sub_sub_id='".$_GET['new']."'";
                                                $r=mysqli_query($conn,$gg);
                                                foreach($r as $key=> $value1)
                                              {
                                                	$question=$value1['question'];
                                                	$answer=$value1['answer'];
                                                		$sub_name=$value1['sub_name'];
                                                    echo'<tr>
                          <td>'.substr($question,0,30).'</td>
                           <td>'.substr($answer,0,150).'</td>
                           <td>'.substr($sub_name,0,150).'</td>
                         
							
						 <td class="menu-action rounded-btn"><a href="editfaq.php?catid='.$value1['id'].'&sid='.$value1['sub_sub_id'].'" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a> <a href="viewfaq.php?deletecat='.$value1['id'].'&sid='.$value1['sub_sub_id'].'""   data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-times"></i> </a></td>
                        </tr>';}?>
