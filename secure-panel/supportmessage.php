              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> view  All Message</h3>
                  </div>
                    ...
                    <table class="table table-striped" id="data-tables">
                     ...
                     <tbody>
                       <?php
                           ...
                           $i=1;
 $query="SELECT DISTINCT saller_id from saller_sopport  order by id DESC";

	$run = mysqli_query($conn,$query);
					   foreach($run as $ke=>$value){
					       
					       $img1="SELECT * from   vendor_login where  code='".$value['saller_id']."' ";
$imge1=mysqli_query($conn,$img1);
foreach($imge1 as $key=> $image1)
 
					   	 ?>
                        <tr>
                             <td>  <?php echo $image1['code'] ;?>   </td>
                          <td>  <?php echo $image1['username'] ;?>   </td>
						 ...
						 <td class="menu-action rounded-btn"> 
						  ...
						  <a target="_blank" href="view-message.php?sku=<?php echo $value['saller_id'];?>" data-original-title="View" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a> 
