...
$item6 = mysqli_real_escape_string($conn,$data[6]); 
 ...
 $category_name1=$category_name;
  $query2="SELECT * from category where category_name='$category_name1'";
...
$import="INSERT into pin(code,codetype,capability,oda,cod,city,state) values('$item0','$item1','$item2','$item3','$item4','$item5','$item6' )";
                  ...
                  <div class="panel-body">
                   ...
                   <div id="dvPassport">  
					  ...
					  <div class="form-group">
                        <label class="col-sm-2 control-label">Add    CSV file</label>
