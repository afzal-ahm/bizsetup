...
if(isset($_GET['addtaxid'])){
    if(isset($_POST['btn-save']))
    {
        ...
        $today = date('Y-m-d');
        $field_value=array($vat,$today);
        $field=array('delivery_price','date');
        $res = $con->insert($field_value,$table,$field);
        if($res)
        {
            ?>
            <script>
                alert("Delivery Price added");
...
if(isset($_GET['deletetax'])){
    ...
    $deletetaxid = $_GET['deletetax']; 
      $delete_promo="DELETE FROM `delivery_price` WHERE id='".$deletetaxid."'";
    $runx=mysqli_query($conn,$delete_promo);
    if($runx)
    {
        ?>
        <script>
            alert("delivery_price Successfully Deleted");
            window.location ='delivery.php'
        </script>
        <?php
    }
                    ...
                    <div class="vd_content clearfix">
                        <div class="vd_title-section clearfix">
                            <div class="vd_panel-header">
                                <h1>pin Panel</h1>
                                <small class="subtitle">List of pin</small> </div>
                        </div>
                        <div class="vd_content-section clearfix">
                                    ...
                                    <div class="panel-body">';
                                       ...
                                       echo'<form class="form-horizontal" action="" method="post" role="form">
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Delivery Price</label>
                                                <div class="col-sm-7 controls">
                                                    <input class="width-70" type="number" value="'.$editdataval['delivery_price'].'" data-toggle="tooltip" data-placement="top" name="vat">
                                                </div>
                                            </div>
                                        ...
                                        echo'<div class="panel widget">
                                    <div class="panel-heading vd_bg-grey">
                                        <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Add Tax </h3>
                                    </div>
                                    <div class="panel-body">
                                     ...
                                     <div class="panel widget">
                                        <div class="panel-heading vd_bg-grey">
                                            ...
                                            <h4 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span><a href="delivery.php?addtaxid"> ADD Delivery</a></h4>
                                        </div>
                          ...
                          <td>'.$taxesval['delivery_price'].'</td> 
                                                    
						  <td>'.$taxesval['date'].'</td>
						 <td class="menu-action rounded-btn"><a href="delivery.php?edittaxid='.$taxesval['id'].'" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a> </td>
                        </tr>';}
