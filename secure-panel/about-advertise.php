...
<div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea   name="content" ><?php echo $dataval['about_us']; ?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Term & condition:</label>
                  <div class="col-sm-8">
                    <textarea   name="term" ><?php echo $dataval['term']; ?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Privacy Policy:</label>
                  <div class="col-sm-8">
                    <textarea    name="privacy" ><?php echo $dataval['privacy_policy']; ?></textarea>
                  </div>
                </div> 
                <div class="form-group">
                  <label class="col-sm-2 control-label">shipping & Delivery:</label>
                  <div class="col-sm-8">
                    <textarea     name="ship" ><?php echo $dataval['ship']; ?></textarea>
                  </div>
                </div>
...
//	   move_uploaded_file($image_tmp, "../images/$imagename");
	...
	$query1 = "UPDATE contact_info SET about_us='$content' , term='$term',privacy_policy='$privacy',ship='$ship' where id='1'";
 ...
 echo "<script type=\"text/javascript\">".
        ...
        "</script>";
echo'<script>location.assign("about-advertise.php")</script>';}
?>  
