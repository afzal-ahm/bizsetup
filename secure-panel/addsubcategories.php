...
<?php
	...
	<script>
alert("Sub-Categories Not Inserted");
//window.location ='index.php'
</script>
<?php
}
...
<!-- vd_panel-menu --> 
          ...
          <div class="row" id="advanced-input">
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Add Package </h3>
                  </div>
                    ...
                    <form class="form-horizontal" action="#" role="form" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <select class="width-40" name="category_name">
                            <option>----All------</option>
                             <?php
                ...
                <div class="form-group">
                        <label class="col-sm-2 control-label">Add Package</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" name="subcategory_name">
                        </div>
                      </div>
                      <!--    
                       <div class="form-group">
                        <label class="col-sm-2 control-label">Add Duration</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" name="duration">
                        </div>
                      </div>
                      
                       <div class="form-group">
                        <label class="col-sm-2 control-label">Add Package StartFrom</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" name="startfrom">
                        </div>
                      </div>
		 	 ...
		 	 <div class="form-group">
                        <label class="col-sm-2 control-label">Add Package Images</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="file" placeholder="Input" data-toggle="tooltip" data-placement="top" name="image" required>
                        </div>
                      </div>  
                         ...
                         <div class="form-group">
                        <label class="col-sm-2 control-label">Add Inclusion</label>
                        <div class="col-sm-7 controls">
                          
                          <textarea class="ckeditor"    id="" cols="70" name="content"  required rows="5"> </textarea>
                        </div>
                      </div> 
                      
                      
                         <div class="form-group">
                        <label class="col-sm-2 control-label">Add Package Exclusion</label>
                        <div class="col-sm-7 controls">
                          
                          <textarea class="ckeditor"    id="" cols="70" name="long_content"  required rows="5"> </textarea>
                        </div>
                      </div>  
                      
                  <div class="form-group">
                        <label class="col-sm-2 control-label">Add SubCategories long Content</label>
                        <div class="col-sm-7 controls">
                          
                          <textarea class="ckeditor"  id="" cols="70" name="long_content"  required rows="20">
